!function (e, t) {
    ...
    "use strict";
    var o = {className: !0, colSpan: !0, rowSpan: !0}, t = {"<tr": "tbody", "<td": "tr"};

    function s(e, t, n) {
        var r = document.createElement(e);
        if (t) for (var i in t) "style" === i ? f(r, t[i]) : o[i] ? r[i] = t[i] : r.setAttribute(i, t[i]);
    ...
    function l(e) {
        var t = "string" == typeof e ? a(e) : e instanceof Node ? [e] : Array.prototype.slice.call(e);
        return t
    }
    ...
    function p(e, t) {
        for (var n = e instanceof HTMLElement ? [e] : e, r = [], i = 0; i < n.length; i++) for (var o = n[i].querySelectorAll(t), s = 0; s < o.length; s++) r.push(o[s]);
        return r
    }
    ...
    function D(e, t) {
        ...
        var n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            s = parseInt(n.borderBottomWidth, 10) || 0, a = w(e.offsetWidth - e.clientWidth - r - i), l = {
                borderLeft: r,
                borderRight: i,
                borderTop: o,
                borderBottom: s,
        ...
        return S() && "rtl" === n.direction ? l.scrollbarLeft = a : l.scrollbarRight = a, t && (l.paddingLeft = parseInt(n.paddingLeft, 10) || 0, l.paddingRight = parseInt(n.paddingRight, 10) || 0, l.paddingTop = parseInt(n.paddingTop, 10) || 0, l.paddingBottom = parseInt(n.paddingBottom, 10) || 0), l
    }
    ...
    function F(e, t, n, r) {
        var i, o, s = W([t, 0, 1 + (-(7 + W([t, 0, o = 7 + (i = n) - r]).getUTCDay() - i) % 7 + o - 1)]), a = V(e),
            l = Math.round(z(s, a));
    ...
    var q = ["years", "months", "days", "milliseconds"], Y = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/;
    ...
    function ce(e, t, n) {
        if ("function" == typeof e && (e = [e]), e) {
            for (var r = void 0, i = void 0, r = 0; r < e.length; r++) i = e[r].apply(t, n) || i;
            return i
        }
    }
    ...
    function pe(t, n) {
        var r, i, o, s, a, l = function () {
            ...
            e < n ? r = setTimeout(l, n - e) : (r = null, a = t.apply(o, i), o = i = null)
        };
        return function () {
            return o = this, i = arguments, s = (new Date).valueOf(), r = r || setTimeout(l, n), a
        }
    }
    ...
    function fe(e) {
        var t = Math.floor(z(e.start, e.end)) || 1, n = V(e.start);
    ...
    function ve(e, t) {
        void 0 === t && (t = X(0));
        var n, r = null, i = null;
        return e.end && (i = V(e.end), (n = e.end.valueOf() - i.valueOf()) && n >= ee(t) && (i = _(i, 1))), e.start && (r = V(e.start), i && i <= r && (i = _(r, 1))), {
            start: r,
            end: i
        }
    }
    ...
    function be(e, t) {
        ...
        if (t) for (n = 0; n < t.length; n++) {
            for (r = t[n], i = [], o = e.length - 1; 0 <= o; o--) if ("object" == typeof (s = e[o][r]) && s) i.unshift(s); else if (void 0 !== s) {
                l[r] = s;
                break
            }
            i.length && (l[r] = be(i))
        }
        for (n = e.length - 1; 0 <= n; n--) for (r in a = e[n]) r in l || (l[r] = a[r]);
        return l
    }
    ...
    function ke(e, t) {
        return void 0 === t && (t = He()), t.defs[e.def.defId] = e.def, e.instance && (t.instances[e.instance.instanceId] = e.instance), t
    }

    function xe(e, t, n) {
        var r, i, o, s, a, l, d = n.dateEnv, c = e.defs, u = we(u = e.instances, function (e) {
            return !c[e.defId].recurringDef
        });
        for (var p in c) {
            var h = c[p];
            if (h.recurringDef) for (var f = (f = h.recurringDef.duration) || (h.allDay ? n.defaultAllDayEventDuration : n.defaultTimedEventDuration), v = 0, g = (r = h, i = f, o = t, s = n.dateEnv, a = n.pluginSystem.hooks.recurringTypes, l = void 0, l = a[r.recurringDef.typeId].expand(r.recurringDef.typeData, {
                start: s.subtract(o.start, i),
                end: o.end
            }, s), r.allDay && (l = l.map(V)), l); v < g.length; v++) {
                var m = g[v], y = At(p, {start: m, end: d.add(m, f)});
                u[y.instanceId] = y
            }
        }
    ...
    function Me(e, t) {
        var n = e.instances[t];
        if (n) {
            var r = e.defs[n.defId], i = Oe(e, function (e) {
    ...
    var je = {week: 3, separator: 0, omitZeroMinute: 0, meridiem: 0, omitCommas: 0},
        Ze = {timeZoneName: 7, era: 6, year: 5, month: 4, day: 2, weekday: 2, hour: 1, minute: 1, second: 1},
        qe = /\s*([ap])\.?m\.?/i, Ye = /,/g, Xe = /\s+/g, Ke = /\u200e/g, Je = /UTC|GMT/,
        Qe = ($e.prototype.format = function (e, t) {
            return this.buildFormattingFunc(this.standardDateProps, this.extendedSettings, t)(e)
        }, $e.prototype.formatRange = function (e, t, n) {
            var r, i, o, s = this.standardDateProps, a = this.extendedSettings,
                l = (r = e.marker, i = t.marker, (o = n.calendarSystem).getMarkerYear(r) === o.getMarkerYear(i) ? o.getMarkerMonth(r) === o.getMarkerMonth(i) ? o.getMarkerDay(r) === o.getMarkerDay(i) ? Z(r) === Z(i) ? 0 : 1 : 2 : 4 : 5);
            if (!l) return this.format(e, n);
            var d = l;
            !(1 < d) || "numeric" !== s.year && "2-digit" !== s.year || "numeric" !== s.month && "2-digit" !== s.month || "numeric" !== s.day && "2-digit" !== s.day || (d = 1);
            var c = this.format(e, n), u = this.format(t, n);
            if (c === u) return c;
            var p = et(function (e, t) {
                var n = {};
                for (var r in e) r in Ze && !(Ze[r] <= t) || (n[r] = e[r]);
                return n
            }(s, d), a, n), h = p(e), f = p(t), v = function (e, t, n, r) {
    ...
    function $e(e) {
        var t = {}, n = {}, r = 0;
        for (var i in e) i in je ? (n[i] = e[i], r = Math.max(je[i], r)) : (t[i] = e[i], i in Ze && (r = Math.max(Ze[i], r)));
        this.standardDateProps = t, this.extendedSettings = n, this.severity = r, this.buildFormattingFunc = Ae(et)
    }
    ...
    function et(e, t, n) {
        ...
        return 1 === r && "short" === e.timeZoneName ? function (e) {
            ...
            r = Se({}, r), i = Se({}, i), function (e, t) {
                e.timeZoneName && (e.hour || (e.hour = "2-digit"), e.minute || (e.minute = "2-digit"));
                "long" === e.timeZoneName && (e.timeZoneName = "short");
                t.omitZeroMinute && (e.second || e.millisecond) && delete t.omitZeroMinute
            }(r, i), r.timeZone = "UTC";
            var s, a = new Intl.DateTimeFormat(o.locale.codes, r);
            {
                var e;
                i.omitZeroMinute && (delete (e = Se({}, r)).minute, s = new Intl.DateTimeFormat(o.locale.codes, e))
            }
            return function (e) {
                var t = e.marker, n = s && !t.getUTCMinutes() ? s : a;
                return function (e, t, n, r, i) {
                    e = e.replace(Ke, ""), "short" === n.timeZoneName && (e = function (e, t) {
                        var n = !1;
    ...
    function ot(e, t) {
        return "object" == typeof e && e ? ("string" == typeof t && (e = Se({separator: t}, e)), new Qe(e)) : "string" == typeof e ? new tt(e, t) : "function" == typeof e ? new rt(e) : void 0
    }
    ...
    var dt = (ct.prototype.remove = function () {
    ...
    var ut = (pt.prototype.setProp = function (e, t) {
        var n, r, i;
        e in Vt || (e in Bt ? ("function" == typeof Bt[e] && (t = Bt[e](t)), this.mutate({standardProps: ((n = {})[e] = t, n)})) : e in Ht && (i = void 0, "function" == typeof Ht[e] && (t = Ht[e](t)), i = "color" === e ? {
            backgroundColor: t,
            borderColor: t
        } : "editable" === e ? {
            startEditable: t,
            durationEditable: t
        } : ((r = {})[e] = t, r), this.mutate({standardProps: {ui: i}})))
    }, pt.prototype.setExtendedProp = function (e, t) {
        var n;
        this.mutate({extendedProps: ((n = {})[e] = t, n)})
    }, pt.prototype.setStart = function (e, t) {
        void 0 === t && (t = {});
        var n, r = this._calendar.dateEnv, i = r.createMarker(e);
        i && this._instance && (n = ge(this._instance.range.start, i, r, t.granularity), t.maintainDuration ? this.mutate({datesDelta: n}) : this.mutate({startDelta: n}))
    }, pt.prototype.setEnd = function (e, t) {
        void 0 === t && (t = {});
        var n, r, i = this._calendar.dateEnv;
        (null == e || (n = i.createMarker(e))) && this._instance && (n ? (r = ge(this._instance.range.end, n, i, t.granularity), this.mutate({endDelta: r})) : this.mutate({standardProps: {hasEnd: !1}}))
    }, pt.prototype.setDates = function (e, t, n) {
        void 0 === n && (n = {});
        var r, i, o, s, a = this._calendar.dateEnv, l = {allDay: n.allDay}, d = a.createMarker(e);
        d && (null == t || (r = a.createMarker(t))) && this._instance && (i = this._instance.range, !0 === n.allDay && (i = fe(i)), o = ge(i.start, d, a, n.granularity), r ? Q(o, s = ge(i.end, r, a, n.granularity)) ? this.mutate({
            datesDelta: o,
            standardProps: l
        }) : this.mutate({startDelta: o, endDelta: s, standardProps: l}) : (l.hasEnd = !1, this.mutate({
            datesDelta: o,
            standardProps: l
        })))
        ...
        var t, n = this._def, r = this._instance;
        r && (this._calendar.dispatch({
            type: "MUTATE_EVENTS",
            instanceId: r.instanceId,
            mutation: e,
            fromApi: !0
        }), t = this._calendar.state.eventStore, this._def = t.defs[n.defId], this._instance = t.instances[r.instanceId])
        ...
        get: function () {
            ...
            return e ? new dt(this._calendar, this._calendar.state.eventSources[e]) : null
        }, enumerable: !0, configurable: !0
    ...
    function ht(e, t, n, r) {
        var i = {}, o = {}, s = {}, a = [], l = [], d = gt(e.defs, t);
        for (var c in e.defs) {
            "inverse-background" === (E = e.defs[c]).rendering && (E.groupId ? (i[E.groupId] = [], s[E.groupId] || (s[E.groupId] = E)) : o[c] = [])
        }
        for (var u in e.instances) {
            var p = e.instances[u], h = d[(E = e.defs[p.defId]).defId], f = p.range, v = !E.allDay && r ? ve(f, r) : f,
                g = Le(v, n);
            g && ("inverse-background" === E.rendering ? E.groupId ? i[E.groupId].push(g) : o[p.defId].push(g) : ("background" === E.rendering ? a : l).push({
                def: E,
                ui: h,
                instance: p,
                range: g,
        ...
        for (var m in i) for (var y = 0, S = ze(i[m], n); y < S.length; y++) {
            var E, b = S[y], h = d[(E = s[m]).defId];
            a.push({def: E, ui: h, instance: null, range: b, isStart: !1, isEnd: !1})
        }
        for (var c in o) for (var w = 0, D = ze(o[c], n); w < D.length; w++) {
            b = D[w];
            a.push({def: e.defs[c], ui: d[c], instance: null, range: b, isStart: !1, isEnd: !1})
        }
        return {bg: a, fg: l}
    }
    ...
    function mt(e, t) {
        var n = [];
        return t[""] && n.push(t[""]), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Nt(n)
    }

    function yt(e, t, n) {
        var r = e.calendar, i = e.view;
        if (r.hasPublicHandlers("eventPositioned")) for (var o = 0, s = t; o < s.length; o++) {
            var a = s[o];
    ...
    function St(e, t, n) {
        ...
        if (r.hasPublicHandlers("eventDestroy")) for (var l = 0, d = t; l < d.length; l++) {
            a = d[l];
    ...
    function Et(e, t, n, r) {
        ...
        for (var l in e.instances) {
            var d = e.instances[l], a = o.defs[d.defId];
            o.instances[l] = function (e, t, n, r, i) {
                var o = i.dateEnv, s = r.standardProps && !0 === r.standardProps.allDay,
                    a = r.standardProps && !1 === r.standardProps.hasEnd, l = Se({}, e);
                ...
                a && (l.range = {start: l.range.start, end: i.getDefaultEventEnd(t.allDay, l.range.start)});
                t.allDay && (l.range = {start: V(l.range.start), end: V(l.range.end)});
    ...
    function bt(e, t, n, r, i) {
        switch (t.type) {
            ...
            case"CHANGE_TIMEZONE":
                return p = e, h = t.oldDateEnv, f = i.dateEnv, v = p.defs, g = De(p.instances, function (e) {
                    var t = v[e.defId];
                    return t.allDay || t.recurringDef ? e : Se({}, e, {
                        range: {
                            start: f.createMarker(h.toDate(e.range.start, e.forcedStartTzo)),
            ...
            case"MUTATE_EVENTS":
                return o = e, s = t.instanceId, a = t.mutation, l = t.fromApi, d = i, c = Me(o, s), u = l ? {
                    "": {
                        startEditable: !0,
                        durationEditable: !0,
                        constraints: [],
                ...
                } : d.eventUiBases, c = Et(c, u, a, d), _e(o, c);
    ...
    function Rt(e, t, n, r) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, r) {
            var i = e.eventDrag, o = i.mutatedEvents, s = o.defs, a = o.instances,
                l = gt(s, i.isEvent ? e.eventUiBases : {"": t.selectionConfig});
            r && (l = De(l, r));
            var d = Dt(e.eventStore, i.affectedEvents.instances), c = d.defs, u = d.instances,
                p = gt(c, e.eventUiBases);
            for (var h in a) {
                var f = a[h], v = f.range, g = l[f.defId], m = s[f.defId];
                ...
                for (var S in "function" != typeof y && (y = null), u) {
                    ...
                    if (Ve(v, E.range)) {
                        ...
                        if (y && !y(new ut(t, c[E.defId], E), new ut(t, m, f))) return !1
                    }
                }
                for (var b = t.state.eventStore, w = 0, D = g.allows; w < D.length; w++) {
                    var T = D[w], C = Se({}, n, {range: f.range, allDay: m.allDay}), R = b.defs[m.defId],
                        I = b.instances[h], k = void 0;
                    if (k = R ? new ut(t, R, I) : new ut(t, m), !T(t.buildDateSpanApi(C), k)) return !1
                }
            }
            return !0
        }(e, t, n, r)) && !(e.dateSelection && !function (e, t, n, r) {
            var i = e.eventStore, o = i.defs, s = i.instances, a = e.dateSelection, l = a.range, d = t.selectionConfig;
            r && (d = r(d));
        ...
        for (var o = 0, s = e; o < s.length; o++) {
            if (!function (e, t) {
            ...
            }(function (t, e, n, r, i) {
                {
                    ...
                    if ("string" == typeof t) return kt(Oe(n, function (e) {
                        return e.groupId === t
                    }));
                    if ("object" == typeof t && t) return kt(xe(t, e, i))
                }
                return []
            }(s[o], t, n, r, i), t)) return
        }
        return 1
    }
    ...
    function _t(e, t, n) {
        var r, i, o = he(e, Ht, {}, n),
            s = (r = o.constraint, i = t, Array.isArray(r) ? Ie(r, "", i, !0) : "object" == typeof r && r ? Ie([r], "", i, !0) : null != r ? String(r) : null);
        return {
            startEditable: null != o.startEditable ? o.startEditable : o.editable,
            durationEditable: null != o.durationEditable ? o.durationEditable : o.editable,
    ...
    function Ot(e, t, n, r) {
        ...
        if ("event" === e && (i.editable = t.editable), r) for (var s in t) o[s] || (r[s] = t[s]);
        return _t(i, n)
    }
    ...
    var Bt = {id: String, groupId: String, title: String, url: String, rendering: String, extendedProps: null},
        Vt = {start: null, date: null, end: null, allDay: null}, Ft = 0;
    ...
    function Gt(e, t, n, r) {
        var i = function (e, t) {
            ...
            return n
        }(t, n), o = {}, s = function (e, t, n, r, i) {
            for (var o = 0; o < r.length; o++) {
                var s = {}, a = r[o].parse(e, s, n);
                if (a) {
                    var l = s.allDay;
                    return delete s.allDay, null == l && null == (l = t) && null == (l = a.allDayGuess) && (l = !1), Se(i, s), {
                        allDay: l,
                        duration: a.duration,
                        typeData: a.typeData,
                        typeId: o
        ...
        if (s) return (a = Ut(o, t, s.allDay, Boolean(s.duration), n)).recurringDef = {
            typeId: s.typeId,
            typeData: s.typeData,
            duration: s.duration
        }, {def: a, instance: null};
        var a, l = {}, d = function (e, t, n, r, i) {
            var o, s, a = function (e, t) {
                var n = he(e, Vt, {}, t);
                return n.start = null !== n.start ? n.start : n.date, delete n.date, n
            }(e, r), l = a.allDay, d = null, c = !1, u = null;
            if (o = n.dateEnv.createMarkerMeta(a.start)) d = o.marker; else if (!i) return null;
            ...
            u ? c = !0 : i || (c = n.opt("forceEventDuration") || !1, u = n.dateEnv.add(d, l ? n.defaultAllDayEventDuration : n.defaultTimedEventDuration));
            return {
                allDay: l,
                hasEnd: c,
                range: {start: d, end: u},
    ...
    function Ut(e, t, n, r, i) {
        var o, s, a, l, d, c = {},
            u = (o = i, s = c, l = he(e, Bt, {}, a = {}), d = _t(a, o, s), l.publicId = l.id, delete l.id, l.ui = d, l);
        u.defId = String(Ft++), u.sourceId = t, u.allDay = n, u.hasEnd = r;
        for (var p = 0, h = i.pluginSystem.hooks.eventDefParsers; p < h.length; p++) {
            var f = {};
            (0, h[p])(u, c, f), c = f
        }
        return u.extendedProps = Se(c, u.extendedProps || {}), Object.freeze(u.ui.classNames), Object.freeze(u.extendedProps), u
    }
    ...
    function Zt(e, n, t) {
        ...
        function a() {
            i && Ue(i, arguments) || (s(), r = this, i = arguments, e.apply(this, arguments))
        }
    ...
    var qt = He(), Yt = (Xt.prototype.splitProps = function (e) {
        var n = this, t = this.getKeyInfo(e), r = this.getKeysForEventDefs(e.eventStore),
            i = this.splitDateSelection(e.dateSelection), o = this.splitIndividualUi(e.eventUiBases, r),
            s = this.splitEventStore(e.eventStore, r), a = this.splitEventDrag(e.eventDrag),
            l = this.splitEventResize(e.eventResize), d = {};
        for (var c in this.eventUiBuilders = De(t, function (e, t) {
            return n.eventUiBuilders[t] || Ae(Kt)
        }), t) {
            var u = t[c], p = s[c] || qt, h = this.eventUiBuilders[c];
            d[c] = {
        ...
        for (var o in n) for (var s = 0, a = t[o]; s < a.length; s++) i[d = a[s]] || (i[d] = He()), i[d].defs[o] = n[o];
        for (var l in r) for (var d, c = r[l], u = 0, p = t[c.defId]; u < p.length; u++) i[d = p[u]] && (i[d].instances[l] = c);
        return i
        ...
        if (t) {
            var r = this._splitEventStore(t.affectedEvents, this._getKeysForEventDefs(t.affectedEvents)),
                e = this._getKeysForEventDefs(t.mutatedEvents), i = this._splitEventStore(t.mutatedEvents, e),
                o = function (e) {
                    n[e] || (n[e] = {
    ...
    function Jt(e, t, n, r, i) {
        var o, s, a, l;
        return n instanceof Date ? o = n : (o = n.date, s = n.type, a = n.forceOff), l = {
            ...
            return t.join(" ")
        }(r) : "", i = i || "", !a && e.navLinks ? "<a" + r + ' data-goto="' + xt(JSON.stringify(l)) + '">' + i + "</a>" : "<span" + r + ">" + i + "</span>"
    }

    function Qt(e, t, n, r) {
        var i, o, s = n.calendar, a = n.options, l = n.theme, d = n.dateEnv, c = [];
        return Ge(t.activeRange, e) ? (c.push("fc-" + H[e.getUTCDay()]), a.monthMode && d.getMonth(e) !== d.getMonth(t.currentRange.start) && c.push("fc-other-month"), o = _(i = V(s.getNow()), 1), e < i ? c.push("fc-past") : o <= e ? c.push("fc-future") : (c.push("fc-today"), !0 !== r && c.push(l.getClass("today")))) : c.push("fc-disabled-day"), c
    }
    ...
    var nn, rn = (ye(on, nn = en), on.prototype.on = function (e, t) {
    ...
    var ln = (dn.prototype.build = function () {
        ...
        for (var t = this.lefts, n = this.rights, r = t.length, i = 0; i < r; i++) if (e >= t[i] && e < n[i]) return i
    }, dn.prototype.topToIndex = function (e) {
        for (var t = this.tops, n = this.bottoms, r = t.length, i = 0; i < r; i++) if (e >= t[i] && e < n[i]) return i
    ...
    var cn = (un.prototype.getMaxScrollTop = function () {
    ...
    var pn, hn = (ye(fn, pn = cn), fn.prototype.getScrollTop = function () {
    ...
    var vn, gn = (ye(mn, vn = cn), mn.prototype.getScrollTop = function () {
    ...
    var yn, Sn = (ye(En, yn = hn), En.prototype.clear = function () {
        ...
        e = e || this.getScrollbarWidths(), "auto" === t && (t = e.bottom || this.canScrollHorizontally() ? "scroll" : "hidden"), "auto" === n && (n = e.left || e.right || this.canScrollVertically() ? "scroll" : "hidden"), f(this.el, {
            overflowX: t,
            overflowY: n
        })
    ...
    var bn = (wn.prototype.processIconOverride = function () {
    ...
    var Dn = 0, Tn = (Cn.prototype.extend = function (e, t) {
        return new Cn(this.calendar, this.theme, this.dateEnv, e || this.options, t || this.view)
    }, Cn);

    function Cn(e, t, n, r, i) {
        this.calendar = e, this.theme = t, this.dateEnv = n, this.options = r, this.view = i, this.isRtl = "rtl" === r.dir, this.eventOrderSpecs = re(r.eventOrder), this.nextDayThreshold = X(r.nextDayThreshold)
    }

    var Rn = (In.addEqualityFuncs = function (e) {
    ...
    var kn, xn = (ye(Mn, kn = Rn), Mn.prototype.destroy = function () {
        ...
        return !(n && !Fe(n.validRange, e.range)) && Ct({dateSelection: e}, t)
    ...
    xn.prototype.fgSegSelector = ".fc-event-container > *", xn.prototype.bgSegSelector = ".fc-bgevent:not(.fc-nonbusiness)";
    var Pn = 0;
    ...
    var _n = (On.prototype.add = function (e) {
    ...
    function Ln(e, t, n, r, i) {
        var o, s, a = null;
        "GET" === (e = e.toUpperCase()) ? (s = n, t = (o = t) + (-1 === o.indexOf("?") ? "?" : "&") + Bn(s)) : a = Bn(n);
        var l = new XMLHttpRequest;
        l.open(e, t, !0), "GET" !== e && l.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), l.onload = function () {
            if (200 <= l.status && l.status < 400) try {
    ...
    var Vn = Hn({
        eventSourceDefs: [{
            parseMeta: function (e) {
                ...
                var t = e.eventSource.meta, i = function (e, t, n) {
                    ...
                    Se(l, s), l[r] = a.formatIso(t.start), l[i] = a.formatIso(t.end), "local" !== a.timeZone && (l[o] = a.timeZone);
                    return l
        ...
        recurringTypes: [{
            parse: function (e, t, n) {
                var r, i, o = n.createMarker.bind(n),
                    s = he(e, {daysOfWeek: null, startTime: X, endTime: X, startRecur: o, endRecur: o}, {}, t), a = !1;
                for (var l in s) if (null != s[l]) {
                    a = !0;
                    break
                }
                if (a) {
                    var d = null;
                    return "duration" in t && (d = X(t.duration), delete t.duration), !d && s.startTime && s.endTime && (r = s.endTime, i = s.startTime, d = {
                        years: r.years - i.years,
                        months: r.months - i.months,
                        days: r.days - i.days,
                        milliseconds: r.milliseconds - i.milliseconds
                    }), {allDayGuess: Boolean(!s.startTime && !s.endTime), duration: d, typeData: s}
                }
                return null
            }, expand: function (e, t, n) {
                var r = Le(t, {start: e.startRecur, end: e.endRecur});
                return r ? function (e, t, n, r) {
                    var i = e ? Te(e) : null, o = V(n.start), s = n.end, a = [];
                    for (; o < s;) {
                        var l = void 0;
                        i && !i[o.getUTCDay()] || (l = t ? r.add(o, t) : o, a.push(l)), o = _(o, 1)
                    }
                    return a
    ...
    var Gn = Hn({
        optionChangeHandlers: {
            events: function (e, t, n) {
                Un([e], t, n)
            }, eventSources: Un, plugins: function (e, t) {
                t.addPluginInputs(e)
            }
        }
    });
    ...
    function Un(e, t, n) {
        for (var r = Ce(t.state.eventSources), i = [], o = 0, s = e; o < s.length; o++) {
            for (var a = s[o], l = !1, d = 0; d < r.length; d++) if (n(r[d]._raw, a)) {
                r.splice(d, 1), l = !0;
                break
            }
            l || i.push(a)
    ...
    function Yn(e) {
        for (var t = 0 < e.length ? e[0].code : "en", n = window.FullCalendarLocalesAll || [], r = window.FullCalendarLocales || {}, i = n.concat(Ce(r), e), o = {en: qn}, s = 0, a = i; s < a.length; s++) {
            var l = a[s];
            o[l.code] = l
        }
    ...
    function Xn(e, t) {
        return "object" != typeof e || Array.isArray(e) ? (r = t, i = [].concat((n = e) || []), o = function (e, t) {
            for (var n = 0; n < e.length; n++) for (var r = e[n].toLocaleLowerCase().split("-"), i = r.length; 0 < i; i--) {
                var o = r.slice(0, i).join("-");
                if (t[o]) return t[o]
            }
            return null
        }(i, r) || qn, Kn(n, i, o)) : Kn(e.code, [e.code], e);
        var n, r, i, o
    }
    ...
    var Jn = (Qn.prototype.mutate = function (e, t, n) {
        ...
        var e = ue(this.dynamicOverrides.locales, this.overrides.locales, An.locales),
            t = ue(this.dynamicOverrides.locale, this.overrides.locale, An.locale), n = Yn(e),
            r = Xn(t || n.defaultCode, n.map).options,
            i = "rtl" === ue(this.dynamicOverrides.dir, this.overrides.dir, r.dir) ? Wn : {};
        this.dirDefaults = i, this.localeDefaults = r, this.computed = be([An, i, r, this.overrides, this.dynamicOverrides], jn)
    }, Qn);
    ...
    var er, tr = (nr.prototype.getMarkerYear = function (e) {
        ...
        return e.getUTCDate()
    }, nr.prototype.arrayToMarker = W, nr.prototype.markerToArray = A, nr);
    ...
    var or = (sr.prototype.createMarker = function (e) {
        var t = this.createMarkerMeta(e);
        return null === t ? null : t.marker
    }, sr.prototype.createNowMarker = function () {
        return this.canComputeOffset ? this.timestampToMarker((new Date).valueOf()) : W(G(new Date))
    }, sr.prototype.createMarkerMeta = function (e) {
        if ("string" == typeof e) return this.parse(e);
        var t = null;
        return "number" == typeof e ? t = this.timestampToMarker(e) : e instanceof Date ? (e = e.valueOf(), isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = W(e)), null !== t && j(t) ? {
            marker: t,
            isTimeUnspecified: !1,
            forcedTzo: null
        } : null
        ...
        var n, r, i, o = this.diffWholeYears(e, t);
        return null !== o ? {unit: "year", value: o} : null !== (o = this.diffWholeMonths(e, t)) ? {
            unit: "month",
            value: o
        } : null !== (o = L(e, t)) ? {unit: "week", value: o} : null !== (o = B(e, t)) ? {
            unit: "day",
            value: o
        } : (n = e, de(o = (t.valueOf() - n.valueOf()) / 36e5) ? {
            unit: "hour",
            value: o
        } : (r = e, de(o = (t.valueOf() - r.valueOf()) / 6e4) ? {
            unit: "minute",
            value: o
        } : (i = e, de(o = (t.valueOf() - i.valueOf()) / 1e3) ? {unit: "second", value: o} : {
            unit: "millisecond",
            value: t.valueOf() - e.valueOf()
        })))
    }, sr.prototype.countDurationsBetween = function (e, t, n) {
        var r;
        return n.years && null !== (r = this.diffWholeYears(e, t)) ? r / ($(n) / 365) : n.months && null !== (r = this.diffWholeMonths(e, t)) ? r / ($(n) / 30) : n.days && null !== (r = B(e, t)) ? r / $(n) : (t.valueOf() - e.valueOf()) / ee(n)
    }, sr.prototype.startOf = function (e, t) {
        return "year" === t ? this.startOfYear(e) : "month" === t ? this.startOfMonth(e) : "week" === t ? this.startOfWeek(e) : "day" === t ? V(e) : "hour" === t ? W([(i = e).getUTCFullYear(), i.getUTCMonth(), i.getUTCDate(), i.getUTCHours()]) : "minute" === t ? W([(r = e).getUTCFullYear(), r.getUTCMonth(), r.getUTCDate(), r.getUTCHours(), r.getUTCMinutes()]) : "second" === t ? W([(n = e).getUTCFullYear(), n.getUTCMonth(), n.getUTCDate(), n.getUTCHours(), n.getUTCMinutes(), n.getUTCSeconds()]) : void 0;
        var n, r, i
        ...
        return this.weekNumberFunc ? this.weekNumberFunc(this.toDate(e)) : function (e, t, n) {
            var r = e.getUTCFullYear(), i = F(e, r, t, n);
        ...
        return void 0 === r && (r = {}), r.isEndExclusive && (t = O(t, -1)), n.formatRange({
            marker: e,
        ...
        return t.omitTimeZoneOffset || (n = null != t.forcedTzo ? t.forcedTzo : this.offsetForMarker(e)), function (e, t, n) {
            ...
            return n && (r = r.replace("T00:00:00Z", "")), 10 < r.length && (null == t ? r = r.replace("Z", "") : 0 !== t && (r = r.replace("Z", st(t, !0)))), r
        }(e, n, t.omitTime)
    }, sr.prototype.timestampToMarker = function (e) {
        return "local" === this.timeZone ? W(G(new Date(e))) : "UTC" !== this.timeZone && this.namedTimeZoneImpl ? W(this.namedTimeZoneImpl.timestampToArray(e)) : new Date(e)
    }, sr.prototype.offsetForMarker = function (e) {
        return "local" === this.timeZone ? -U(A(e)).getTimezoneOffset() : "UTC" === this.timeZone ? 0 : this.namedTimeZoneImpl ? this.namedTimeZoneImpl.offsetForArray(A(e)) : null
    }, sr.prototype.toDate = function (e, t) {
        return "local" === this.timeZone ? U(A(e)) : "UTC" === this.timeZone ? new Date(e.valueOf()) : this.namedTimeZoneImpl ? new Date(e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(A(e)) * 60) : new Date(e.valueOf() - (t || 0))
    }, sr);
    ...
    var ar = {id: String, allDayDefault: Boolean, eventDataTransform: Function, success: Function, failure: Function},
        lr = 0;
    ...
    function cr(e, t) {
        for (var n, r, i, o, s, a, l, d, c = t.pluginSystem.hooks.eventSourceDefs, u = c.length - 1; 0 <= u; u--) {
            var p = c[u].parseMeta(e);
            if (p) {
                var h = (r = p, i = u, o = t, d = l = a = s = void 0, a = he(n = "object" == typeof e ? e : {}, ar, {}, s = {}), d = _t(s, o, l = {}), a.isFetching = !1, a.latestFetchId = "", a.fetchRange = null, a.publicId = String(n.id || ""), a.sourceId = String(lr++), a.sourceDefId = i, a.meta = r, a.ui = d, a.extendedProps = l, a);
                return h._raw = e, h
            }
        }
        return null
    ...
    function ur(e, t, n, r) {
        switch (t.type) {
            ...
            case"REMOVE_EVENT_SOURCE":
                return o = e, s = t.sourceId, we(o, function (e) {
                    return e.sourceId !== s
                });
            case"PREV":
            case"NEXT":
            ...
            case"CHANGE_TIMEZONE":
                return fr(e, t.sourceIds ? Te(t.sourceIds) : (i = r, we(e, function (e) {
                    return dr(e, i)
                })), n ? n.activeRange : null, r);
            case"RECEIVE_EVENTS":
    ...
    function hr(e, i, o) {
        return fr(e, we(e, function (e) {
            return n = i, dr(t = e, r = o) ? !r.opt("lazyFetching") || !t.fetchRange || t.isFetching || n.start < t.fetchRange.start || n.end > t.fetchRange.end : !t.latestFetchId;
            var t, n, r
        }), i, o)
    }
    ...
    function fr(e, t, n, r) {
        ...
        for (var o in e) {
            var s = e[o];
            t[o] ? i[o] = function (o, s, a) {
                var e = a.pluginSystem.hooks.eventSourceDefs[o.sourceDefId], l = String(pr++);
                return e.fetch({eventSource: o, calendar: a, range: s}, function (e) {
                    var t, n, r = e.rawEvents, i = a.opt("eventSourceSuccess");
                    o.success && (n = o.success(r, e.xhr)), i && (t = i(r, e.xhr)), r = n || t || r, a.dispatch({
                        type: "RECEIVE_EVENTS",
                        sourceId: o.sourceId,
                        fetchId: l,
                        fetchRange: s,
                    ...
                    console.warn(e.message, e), o.failure && o.failure(e), t && t(e), a.dispatch({
    ...
    var vr = (gr.prototype.buildPrev = function (e, t) {
        ...
        void 0 === n && (n = !1);
        var r, i, o, s, a, l, d, c, u, p = this.buildValidRange();
        return p = this.trimHiddenDays(p), n && (c = e, e = null != (u = p).start && c < u.start ? u.start : null != u.end && c >= u.end ? new Date(u.end.valueOf() - 1) : c), o = this.buildCurrentRangeInfo(e, t), s = /^(year|month|week|day)$/.test(o.unit), a = this.buildRenderRange(this.trimHiddenDays(o.range), o.unit, s), l = a = this.trimHiddenDays(a), this.options.showNonCurrentDates || (l = Le(l, o.range)), r = X(this.options.minTime), i = X(this.options.maxTime), l = Le(l = this.adjustActiveRange(l, r, i), p), d = Ve(o.range, p), {
            validRange: p,
        ...
        return r.duration ? (o = r.duration, s = r.durationUnit, a = this.buildRangeFromDuration(e, t, o, s)) : (n = this.options.dayCount) ? (s = "day", a = this.buildRangeFromDayCount(e, t, n)) : (a = this.buildCustomVisibleRange(e)) ? s = i.greatestWholeUnit(a.start, a.end).unit : (s = te(o = this.getFallbackDuration()).unit, a = this.buildRangeFromDuration(e, t, o, s)), {
            duration: o,
            unit: s,
            range: a
        }
        ...
        return this.viewSpec.class.prototype.usesMinMaxTime && ($(t) < 0 && (i = V(i), i = r.add(i, t)), 1 < $(n) && (o = _(o = V(o), -1), o = r.add(o, n))), {
            start: i,
            end: o
        }
    }, gr.prototype.buildRangeFromDuration = function (e, t, n, r) {
        var i, o, s, a, l, d = this.dateEnv, c = this.options.dateAlignment;

        function u() {
            s = d.startOf(e, c), a = d.add(s, n), l = {start: s, end: a}
        }

        return c || (i = this.options.dateIncrement, c = i && ee(o = X(i)) < ee(n) ? te(o, !J(i)).unit : r), $(n) <= 1 && this.isHiddenDay(s) && (s = V(s = this.skipHiddenDays(s, t))), u(), this.trimHiddenDays(l) || (e = this.skipHiddenDays(e, t), u()), l
    }, gr.prototype.buildRangeFromDayCount = function (e, t, n) {
        var r, i = this.dateEnv, o = this.options.dateAlignment, s = 0, a = e;
        for (o && (a = i.startOf(a, o)), a = V(a), r = a = this.skipHiddenDays(a, t); r = _(r, 1), this.isHiddenDay(r) || s++, s < n;) ;
        ...
        return n ? X(n) : (t = this.options.dateAlignment) ? X(1, t) : e || X({days: 1})
    }, gr.prototype.getRangeOption = function (e) {
        for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
        var r, i, o, s, a = this.options[e];
        return "function" == typeof a && (a = a.apply(null, t)), a && (r = a, i = this.dateEnv, s = o = null, r.start && (o = i.createMarker(r.start)), r.end && (s = i.createMarker(r.end)), a = !o && !s || o && s && s < o ? null : {
            start: o,
            end: s
        }), a = a && ve(a)
        ...
        var t = e.start, n = e.end, t = t && this.skipHiddenDays(t), n = n && this.skipHiddenDays(n, -1, !0);
        ...
        for (void 0 === t && (t = 1), void 0 === n && (n = !1); this.isHiddenDayHash[(e.getUTCDay() + (n ? t : 0) + 7) % 7];) e = _(e, t);
        return e
    }, gr);
        ...
        for (var r = function (e, t) {
            ...
            switch (t.type) {
                ...
                case"NEXT":
                    ...
                    break;
                case"SET_DATE":
                    e.activeRange && Ge(e.currentRange, t.dateMarker) || (o = i.dateProfileGenerators[r].build(t.dateMarker, void 0, !0));
                    break;
                case"SET_VIEW_TYPE":
            ...
            return !o || !o.isValid || e && function (e, t) {
                return Be(e.validRange, t.validRange) && Be(e.activeRange, t.activeRange) && Be(e.renderRange, t.renderRange) && Q(e.minTime, t.minTime) && Q(e.maxTime, t.maxTime)
            }(e, o) ? e : o
        }(e.dateProfile, t, e.currentDate, r, n), o = ur(e.eventSources, t, i, n), s = Se({}, e, {
            viewType: r,
            dateProfile: i,
            currentDate: function (e, t, n) {
                switch (t.type) {
                    ...
                    case"SET_VIEW_TYPE":
                        ...
                        return n.activeRange && !Ge(n.activeRange, r) ? n.currentRange.start : r;
                    default:
                        return e
                }
            }(e.currentDate, t, i),
            ...
            loadingLevel: yr(o)
        }), a = 0, l = n.pluginSystem.hooks.reducers; a < l.length; a++) s = (0, l[a])(s, t, n);
        return s
    }
    ...
    function Er(e, t, n) {
        var r = function (e, t) {
            var n = {}, r = he(e, Sr, {}, n), i = r.start ? t.createMarkerMeta(r.start) : null,
                o = r.end ? t.createMarkerMeta(r.end) : null, s = r.allDay;
            null == s && (s = i && i.isTimeUnspecified && (!o || o.isTimeUnspecified));
            return n.range = {start: i ? i.marker : null, end: o ? o.marker : null}, n.allDay = s, n
        }(e, t), i = r.range;
    ...
    function br(e, t, n, r) {
        ...
        var i = function (e, t, n, r) {
            ...
            var o = n[e], s = r[e], a = i("class"), l = i("superType");
            !l && a && (l = wr(a, r) || wr(a, n));
            var d = null;
            if (l) {
    ...
    function Rr(e, t) {
        var n = Dr(e), r = Dr(t.overrides.views);
        return De(function (e, t) {
            ...
            return function (r, e, t) {
                ...
                {
                    var l;
                    n && (i = X(n)) && (l = te(i, !J(n)), o = l.unit, 1 === l.value && (a = e[s = o] ? e[o].options : {}))
                }

                function d(e) {
                    var t = e.buttonText || {}, n = r.defaults.buttonTextKey;
                    return null != n && null != t[n] ? t[n] : null != t[r.type] ? t[r.type] : null != t[s] ? t[s] : void 0
                }
                ...
                return {
                    ...
                    durationUnit: o,
                    singleUnit: s,
                    options: Se({}, An, r.defaults, t.dirDefaults, t.localeDefaults, t.overrides, a, r.overrides, t.dynamicOverrides),
                    buttonTextOverride: d(t.dynamicOverrides) || d(t.overrides) || r.overrides.buttonText,
                    buttonTextDefault: d(t.localeDefaults) || d(t.dirDefaults) || r.defaults.buttonText || d(An) || r.type
                }
            }(e, r, t)
        })
    }

    var Ir, kr = (ye(xr, Ir = Rn), xr.prototype.destroy = function () {
        Ir.prototype.destroy.call(this), this._renderLayout.unrender(), r(this.el)
        ...
        var t = this.el;
        this.viewsWithButtons = [], b(t, this.renderSection("left", e.left)), b(t, this.renderSection("center", e.center)), b(t, this.renderSection("right", e.right))
    }, xr.prototype.unrenderLayout = function () {
        this.el.innerHTML = ""
    }, xr.prototype.renderSection = function (e, t) {
        var h = this, n = this.context, f = n.theme, v = n.calendar, r = v.optionsManager, g = v.viewSpecs,
            i = s("div", {className: "fc-" + e}), m = r.computed.customButtons || {}, y = r.overrides.buttonText || {},
            S = r.computed.buttonText || {};
        return t && t.split(" ").forEach(function (e, t) {
            var n, r, u = [], p = !0;
            e.split(",").forEach(function (e, t) {
                var n, r, i, o, s, a, l, d, c;
                "title" === e ? (u.push(E("<h2>&nbsp;</h2>")), p = !1) : ((n = m[e]) ? (i = function (e) {
                    n.click && n.click.call(d, e)
                }, (o = f.getCustomButtonIconClass(n)) || (o = f.getIconClass(e)) || (s = n.text)) : (r = g[e]) ? (h.viewsWithButtons.push(e), i = function () {
                    v.changeView(e)
                }, (s = r.buttonTextOverride) || (o = f.getIconClass(e)) || (s = r.buttonTextDefault)) : v[e] && (i = function () {
                    v[e]()
                }, (s = y[e]) || (o = f.getIconClass(e)) || (s = S[e])), i && (l = ["fc-" + e + "-button", f.getClass("button")], s ? (a = xt(s), c = "") : o && (a = "<span class='" + o + "'></span>", c = ' aria-label="' + e + '"'), (d = E('<button type="button" class="' + l.join(" ") + '"' + c + ">" + a + "</button>")).addEventListener("click", i), u.push(d)))
            }), 1 < u.length ? (n = document.createElement("div"), r = f.getClass("buttonGroup"), p && r && n.classList.add(r), b(n, u), i.appendChild(n)) : b(i, u)
        }), i
    ...
    var Mr, Pr = (ye(Hr, Mr = Rn), Hr.prototype.render = function (e, t) {
        ...
        this.header && this.header.destroy(), this.footer && this.footer.destroy(), this.renderSkeleton.unrender(), Mr.prototype.destroy.call(this)
    }, Hr.prototype._renderSkeleton = function (e) {
        this.updateElClassNames(e), m(this.el, this.contentEl = s("div", {className: "fc-view-container"}));
        for (var t = e.calendar, n = 0, r = t.pluginSystem.hooks.viewContainerModifiers; n < r.length; n++) (0, r[n])(this.contentEl, t)
    }, Hr.prototype._unrenderSkeleton = function () {
        this.view && (this.savedScroll = this.view.queryScroll(), this.view.destroy(), this.view = null), r(this.contentEl), this.removeElClassNames()
        ...
        var i = this.context, o = this.header, s = this.footer, a = i.options, l = i.calendar, d = a.header,
            c = a.footer, u = this.props.dateProfileGenerator, p = l.getNow(), h = u.build(p), f = u.buildPrev(t, n),
            v = u.buildNext(t, n), g = {
                title: r,
                activeButton: e.type,
        ...
        d ? (o || (o = this.header = new kr("fc-header-toolbar"), m(this.el, o.el)), o.receiveProps(Se({layout: d}, g), i)) : o && (o.destroy(), o = this.header = null), c ? (s || (s = this.footer = new kr("fc-footer-toolbar"), b(this.el, s.el)), s.receiveProps(Se({layout: c}, g), i)) : s && (s.destroy(), s = this.footer = null)
        ...
        var n = this.view, r = this.context, i = r.calendar, o = r.options, s = e.viewSpec, a = e.dateProfileGenerator;
        n && n.viewSpec === s || (n && n.destroy(), n = this.view = new s.class(s, this.contentEl), this.savedScroll && (n.addScroll(this.savedScroll, !0), this.savedScroll = null)), n.title = t;
        for (var l = {
        ...
        }, d = 0, c = this.buildViewPropTransformers(i.pluginSystem.hooks.viewPropsTransformers); d < c.length; d++) {
            var u = c[d];
        ...
        var e, t = this.context.calendar, n = t.opt("height"), r = t.opt("contentHeight");
        ...
        f(this.el, {height: this.el.getBoundingClientRect().height, overflow: "hidden"})
    ...
    function Hr(e) {
        ...
        return t.elClassNames = [], t.renderSkeleton = Zt(t._renderSkeleton, t._unrenderSkeleton), t.renderToolbars = Zt(t._renderToolbars, t._unrenderToolbars, [t.renderSkeleton]), t.buildComponentContext = Ae(Or), t.buildViewPropTransformers = Ae(zr), t.el = e, t.computeTitle = Ae(_r), t.parseBusinessHours = Ae(function (e) {
    ...
    function _r(e, t) {
        ...
        return this.context.dateEnv.formatRange(n.start, n.end, ot(t.titleFormat || function (e) {
            var t = e.currentRangeUnit;
            {
                ...
                return null !== n && 1 < n ? {year: "numeric", month: "short", day: "numeric"} : {
                    year: "numeric",
                    month: "long",
                    day: "numeric"
                }
    ...
    var Nr = (Lr.prototype.destroy = function () {
    }, Lr);
    ...
    var Br, Vr = {}, Fr = (ye(Gr, Br = Nr), Gr);

    function Gr(e) {
        var d = Br.call(this, e) || this;
        d.handleSegClick = function (e, t) {
            var n, r, i = d.component, o = i.context, s = o.calendar, a = o.view, l = vt(t);
            l && i.isValidSegDownEl(e.target) && (r = (n = c(e.target, ".fc-has-url")) ? n.querySelector("a[href]").href : "", s.publiclyTrigger("eventClick", [{
                el: t,
                event: new ut(i.context.calendar, l.eventRange.def, l.eventRange.instance),
                jsEvent: e,
                view: a
            }]), r && !e.defaultPrevented && (window.location.href = r))
        };
        var t = e.component;
        return d.destroy = M(t.el, "click", t.fgSegSelector + "," + t.bgSegSelector, d.handleSegClick), d
    }

    var Ur, Ar = (ye(Wr, Ur = Nr), Wr.prototype.destroy = function () {
        ...
        var r = this.component, i = r.context, o = i.calendar, s = i.view, a = vt(n);
    ...
    function Wr(e) {
        ...
        n.handleEventElRemove = function (e) {
            ...
            vt(t) && (t.classList.add("fc-allow-mouse-resize"), n.currentSegEl = t, n.triggerEvent("eventMouseEnter", e, t))
        ...
        var t, r, i, o, s, a = e.component;
        return n.removeHoverListeners = (t = a.el, r = a.fgSegSelector + "," + a.bgSegSelector, i = n.handleSegEnter, o = n.handleSegLeave, M(t, "mouseover", r, function (e, t) {
            var n;
            t !== s && (i(e, s = t), n = function (e) {
                s = null, o(e, t), t.removeEventListener("mouseleave", n)
            }, t.addEventListener("mouseleave", n))
        })), a.context.calendar.on("eventElRemove", n.handleEventElRemove), n
    }

    var jr, Zr = (ye(qr, jr = bn), qr);
    ...
    var Yr = (Xr.prototype.addPluginInputs = function (e) {
        for (var t = 0, n = function (e) {
            for (var t = [], n = 0, r = e; n < r.length; n++) {
                var i, o = r[n];
                "string" == typeof o ? (i = "FullCalendar" + ae(o), window[i] ? t.push(window[i].default) : console.warn("Plugin file not loaded for " + o)) : t.push(o)
            }
            return Zn.concat(t)
        }(e); t < n.length; t++) {
            var r = n[t];
        ...
        this.component ? this.requestRerender() : (this.component = new Pr(this.el), this.renderableEventStore = He(), this.bindHandlers(), this.executeRender())
        ...
        var a = this;
        this.removeNavLinkListener = M(this.el, "click", "a[data-goto]", function (e, t) {
            var n = (n = t.getAttribute("data-goto")) ? JSON.parse(n) : {}, r = a.dateEnv, i = r.createMarker(n.date),
                o = n.type, s = a.viewOpt("navLink" + ae(o) + "Click");
            "function" == typeof s ? s(r.toDate(i), e) : ("string" == typeof s && (o = s), a.zoomTo(i, o))
    ...
    }, Xr.prototype.reduce = mr, Xr.prototype.requestRerender = function () {
        ...
        var i = this.renderableEventStore = e.eventSourceLoadingLevel && !this.opt("progressiveEventRendering") ? this.renderableEventStore : e.eventStore,
            o = this.buildEventUiSingleBase(r.options), s = this.buildEventUiBySource(e.eventSources),
        ...
        var i = this, o = this.pluginSystem.hooks.optionChangeHandlers, s = {}, a = {}, l = this.dateEnv, d = !1,
            c = !1, u = Boolean(t.length);
        for (var p in e) o[p] ? a[p] = e[p] : s[p] = e[p];
        for (var h in s) /^(height|contentHeight|aspectRatio)$/.test(h) ? c = !0 : /^(defaultDate|defaultView)$/.test(h) || (u = !0, "timeZone" === h && (d = !0));
        this.optionsManager.mutate(s, t, n), u && this.handleOptions(this.optionsManager.computed), this.batchRendering(function () {
            if (u ? (d && i.dispatch({type: "CHANGE_TIMEZONE", oldDateEnv: l}), i.dispatch({
                type: "SET_VIEW_TYPE",
                viewType: i.state.viewType
            })) : c && i.updateSize(), r) for (var e in a) o[e](a[e], i, r)
        })
        ...
        this.dateEnv = this.buildDateEnv(i, e.timeZone, n.namedTimeZonedImpl, e.firstDay, e.weekNumberCalculation, e.weekLabel, n.cmdFormatter), this.selectionConfig = this.buildSelectionConfig(e), this.viewSpecs = Rr(n.views, this.optionsManager), this.dateProfileGenerators = De(this.viewSpecs, function (e) {
        ...
        return e.editable && (e = Se({}, e, {eventEditable: !0})), Ot("event", e, this)
        ...
        var n, r = {component: e, el: (n = t).el, useEventCenter: null == n.useEventCenter || n.useEventCenter},
            i = [Fr, Ar].concat(this.pluginSystem.hooks.componentInteractions).map(function (e) {
                return new e(r)
            });
        ...
        var n = null == t ? null != e.start ? e : {start: e, end: null} : {start: e, end: t},
        ...
        var n = t;
        return n = e ? (n = V(n), this.dateEnv.add(n, this.defaultAllDayEventDuration)) : this.dateEnv.add(n, this.defaultTimedEventDuration)
        ...
        var i;
        if (t instanceof dt) i = t.internalEventSource.sourceId; else if (null != t) {
        ...
        for (var n in e = String(e), t) if (t[n].publicId === e) return new dt(this, t[n]);
        return null
    }, Xr.prototype.addEventSource = function (e) {
        if (e instanceof dt) return this.state.eventSources[e.internalEventSource.sourceId] || this.dispatch({
            type: "ADD_EVENT_SOURCES",
            sources: [e.internalEventSource]
        }), e;
        var t = cr(e, this);
        return t ? (this.dispatch({type: "ADD_EVENT_SOURCES", sources: [t]}), new dt(this, t)) : null
    ...
    function Xr(e, t) {
        var n = this;
        this.buildComponentContext = Ae(Kr), this.parseRawLocales = Ae(Yn), this.buildLocale = Ae(Xn), this.buildDateEnv = Ae(Jr), this.buildTheme = Ae(Qr), this.buildEventUiSingleBase = Ae(this._buildEventUiSingleBase), this.buildSelectionConfig = Ae(this._buildSelectionConfig), this.buildEventUiBySource = We(ei, Re), this.buildEventUiBases = Ae(ti), this.interactionsStore = {}, this.actionQueue = [], this.isReducing = !1, this.needsRerender = !1, this.isRendering = !1, this.renderingPauseDepth = 0, this.buildDelayedRerender = Ae($r), this.afterSizingTriggers = {}, this.isViewUpdated = !1, this.isDatesUpdated = !1, this.isEventsUpdated = !1, this.el = e, this.optionsManager = new Jn(t || {}), this.pluginSystem = new _n, this.addPluginInputs(this.optionsManager.computed.plugins || []), this.handleOptions(this.optionsManager.computed), this.publiclyTrigger("_init"), this.hydrate(), this.calendarInteractions = this.pluginSystem.hooks.calendarInteractions.map(function (e) {
            return new e(n)
        })
    }
    ...
    rn.mixInto(Yr);
    var ni, ri = (ye(ii, ni = xn), ii.prototype.initialize = function () {
        ...
        this.renderDates(e), this.addScroll({duration: X(this.context.options.scrollTime)})
        ...
        var n = this.props;
        return ht(e, n.eventUiBases, n.dateProfile.activeRange, t ? this.context.nextDayThreshold : null).fg
        ...
        s.options.nowIndicator && !this.initialNowDate && (n = this.getNowIndicatorUnit(e, t)) && (r = this.updateNowIndicator.bind(this), this.initialNowDate = a.getNow(), this.initialNowQueriedMs = (new Date).valueOf(), i = l.add(l.startOf(this.initialNowDate, n), X(1, n)).valueOf() - this.initialNowDate.valueOf(), this.nowIndicatorTimeoutID = setTimeout(function () {
        ...
        this.props.dateProfile && this.initialNowDate && (this.unrenderNowIndicator(), this.renderNowIndicator(O(this.initialNowDate, (new Date).valueOf() - this.initialNowQueriedMs)), this.isNowIndicatorRendered = !0)
    ...
    var oi = (si.prototype.renderSegs = function (e, t, n) {
        ...
        St(this.context, this.segs, Boolean(n)), this.detachSegs(this.segs), this.segs = []
        ...
        return null == r && (r = this.eventTimeFormat), null == i && (i = this.displayEventEnd), this.displayEventTime && !n ? i && t ? a.formatRange(e, t, r, {
            forcedStartTzo: o,
            forcedEndTzo: s
        ...
        var n = this.context.eventOrderSpecs, t = e.map(ai);
    ...
    var li = (di.prototype.getSegsByType = function (e) {
        ...
        if (r.length) {
            ...
            a(i).forEach(function (e, t) {
                var n = r[t];
                e && (n.el = e)
            }), "bgEvent" === e && (r = ft(this.context, r, !1)), r = r.filter(function (e) {
        ...
        var n = null, r = [];
        return "highlight" !== e && "businessHours" !== e && (n = {"background-color": t.eventRange.ui.backgroundColor}), "highlight" !== e && (r = r.concat(t.eventRange.ui.classNames)), "businessHours" === e ? r.push("fc-bgevent") : r.push("fc-" + e.toLowerCase()), "<" + this.fillSegTag + (r.length ? ' class="' + r.join(" ") + '"' : "") + (n ? ' style="' + Mt(n) + '"' : "") + "></" + this.fillSegTag + ">"
    ...
    var ui = (pi.prototype.destroy = function () {
    ...
    function hi(e) {
        ...
        return e = Se({timeZone: An.timeZone, calendarSystem: "gregory"}, e, {locale: t}), new or(e)
    }

    var fi = {startTime: X, duration: X, create: Boolean, sourceId: String}, vi = {create: !0};

    function gi(e, t) {
        return !e || 10 < t ? {weekday: "short"} : 1 < t ? {
            weekday: "short",
            month: "numeric",
            day: "numeric",
            omitCommas: !0
    ...
    function mi(e, t, n, r, i, o, s, a) {
        var l = o.dateEnv, d = o.theme, c = o.options, u = Ge(t.activeRange, e),
            p = ["fc-day-header", d.getClass("widgetHeader")],
            h = "function" == typeof c.columnHeaderHtml ? c.columnHeaderHtml(l.toDate(e)) : "function" == typeof c.columnHeaderText ? xt(c.columnHeaderText(l.toDate(e))) : xt(l.format(e, i));
        return n ? p = p.concat(Qt(e, t, o, !0)) : p.push("fc-" + H[e.getUTCDay()]), '<th class="' + p.join(" ") + '"' + (u && n ? ' data-date="' + l.formatIso(e, {omitTime: !0}) + '"' : "") + (1 < s ? ' colspan="' + s + '"' : "") + (a ? " " + a : "") + ">" + (u ? Jt(c, l, {
            date: e,
            forceOff: !n || 1 === r
        }, h) : h) + "</th>"
    }

    var yi, Si = (ye(Ei, yi = Rn), Ei.prototype.render = function (e, t) {
        var n = e.dates, r = e.datesRepDistinctDays, i = [];
        this.renderSkeleton(t), e.renderIntroHtml && i.push(e.renderIntroHtml());
        for (var o = ot(t.options.columnHeaderFormat || gi(r, n.length)), s = 0, a = n; s < a.length; s++) {
            var l = a[s];
        ...
        n.innerHTML = "", n.appendChild(this.el = E('<div class="fc-row ' + t.getClass("headerRow") + '"><table class="' + t.getClass("tableGrid") + '"><thead></thead></table></div>')), this.thead = this.el.querySelector("thead")
    ...
    function Ei(e) {
        ...
        return t.renderSkeleton = Zt(t._renderSkeleton, t._unrenderSkeleton), t.parentEl = e, t
    }

    var bi = (wi.prototype.sliceRange = function (e) {
        var t = this.getDateDayIndex(e.start), n = this.getDateDayIndex(_(e.end, -1)), r = Math.max(0, t),
        ...
        var t = this.indices, n = Math.floor(z(this.dates[0], e));
        return n < 0 ? t[0] - 1 : n >= t.length ? t[t.length - 1] + 1 : t[n]
    }, wi);

    function wi(e, t) {
        for (var n = e.start, r = e.end, i = [], o = [], s = -1; n < r;) t.isHiddenDay(n) ? i.push(s + .5) : (s++, i.push(s), o.push(n)), n = _(n, 1);
        this.dates = o, this.indices = i, this.cnt = o.length
    }

    var Di = (Ti.prototype.buildCells = function () {
        ...
        if (n) for (var i = n.firstIndex, o = n.lastIndex, s = i; s <= o;) {
            var a = Math.floor(s / t), l = Math.min((a + 1) * t, o + 1);
            r.push({
                row: a,
                firstCol: s % t,
                lastCol: (l - 1) % t,
    ...
    var Ci = (Ri.prototype.sliceProps = function (e, t, n, r, i) {
        for (var o = [], s = 5; s < arguments.length; s++) o[s - 5] = arguments[s];
        var a = e.eventUiBases, l = this.sliceEventStore.apply(this, [e.eventStore, a, t, n, i].concat(o));
        return {
        ...
        return this._sliceDateSpan.apply(this, [{range: {start: e, end: O(e, 1)}, allDay: !1}, {}, t].concat(n))
    }, Ri.prototype._sliceBusinessHours = function (e, t, n, r, i) {
        for (var o = [], s = 5; s < arguments.length; s++) o[s - 5] = arguments[s];
        return e ? this._sliceEventStore.apply(this, [xe(e, Ii(t, Boolean(n)), r), {}, t, n, i].concat(o)).bg : []
        ...
        if (!e) return [];
        for (var o, s, a, l, d = (o = e, s = t, a = n.context.calendar, {
            ...
            isStart: !0,
            isEnd: !0
        }), c = this.sliceRange.apply(this, [e.range].concat(r)), u = 0, p = c; u < p.length; u++) {
            var h = p[u];
    ...
    function Ri() {
        this.sliceBusinessHours = Ae(this._sliceBusinessHours), this.sliceDateSelection = Ae(this._sliceDateSpan), this.sliceEventStore = Ae(this._sliceEventStore), this.sliceEventDrag = Ae(this._sliceInteraction), this.sliceEventResize = Ae(this._sliceInteraction)
    }

    function Ii(e, t) {
        var n = e.activeRange;
        return t ? n : {start: O(n.start, e.minTime.milliseconds), end: O(n.end, e.maxTime.milliseconds - 864e5)}
    }

    e.Calendar = Yr, e.Component = Rn, e.ComponentContext = Tn, e.DateComponent = xn, e.DateEnv = or, e.DateProfileGenerator = vr, e.DayHeader = Si, e.DaySeries = bi, e.DayTable = Di, e.ElementDragging = ui, e.ElementScrollController = hn, e.EmitterMixin = rn, e.EventApi = ut, e.FgEventRenderer = oi, e.FillRenderer = li, e.Interaction = Nr, e.Mixin = en, e.NamedTimeZoneImpl = ci, e.PositionCache = ln, e.ScrollComponent = Sn, e.ScrollController = cn, e.Slicer = Ci, e.Splitter = Yt, e.Theme = bn, e.View = ri, e.WindowScrollController = gn, e.addDays = _, e.addDurations = function (e, t) {
        return {
    ...
    }, e.addMs = O, e.addWeeks = function (e, t) {
        var n = A(e);
        return n[2] += 7 * t, W(n)
    ...
    }, e.appendToElement = b, e.applyAll = ce, e.applyMutationToEventStore = Et, e.applyStyle = f, e.applyStyleProp = v, e.asRoughMinutes = function (e) {
        return ee(e) / 6e4
    }, e.asRoughMs = ee, e.asRoughSeconds = function (e) {
        return ee(e) / 1e3
    }, e.buildGotoAnchorHtml = Jt, e.buildSegCompareObj = ai, e.capitaliseFirstLetter = ae, e.combineEventUis = Nt, e.compareByFieldSpec = oe, e.compareByFieldSpecs = ie, e.compareNumbers = function (e, t) {
        return e - t
    }, e.compensateScroll = function (e, t) {
        t.left && f(e, {borderLeftWidth: 1, marginLeft: t.left - 1}), t.right && f(e, {
            borderRightWidth: 1,
    ...
    }, e.computeEdges = D, e.computeEventDraggable = function (e, t, n) {
        for (var r = e.calendar, i = e.view, o = r.pluginSystem.hooks.isDraggableTransformers, s = n.startEditable, a = 0, l = o; a < l.length; a++) s = (0, l[a])(s, t, n, i);
        return s
    ...
    }, e.computeFallbackHeaderFormat = gi, e.computeHeightAndMargins = R, e.computeInnerRect = T, e.computeRect = C, e.computeVisibleDayRange = ve, e.config = {}, e.constrainPoint = function (e, t) {
        return {left: Math.min(Math.max(e.left, t.left), t.right), top: Math.min(Math.max(e.top, t.top), t.bottom)}
    }, e.createDuration = X, e.createElement = s, e.createEmptyEventStore = He, e.createEventInstance = At, e.createFormatter = ot, e.createPlugin = Hn, e.cssToStr = Mt, e.debounce = pe, e.diffDates = ge, e.diffDayAndTime = N, e.diffDays = z, e.diffPoints = function (e, t) {
        return {left: e.left - t.left, top: e.top - t.top}
    }, e.diffWeeks = function (e, t) {
        return z(e, t) / 7
    }, e.diffWholeDays = B, e.diffWholeWeeks = L, e.disableCursor = function () {
        document.body.classList.add("fc-not-allowed")
    }, e.distributeHeight = function (o, e, t) {
        var s = Math.floor(e / o.length), a = Math.floor(e - s * (o.length - 1)), l = [], d = [], c = [], u = 0;
        ne(o), o.forEach(function (e, t) {
            var n = t === o.length - 1 ? a : s, r = e.getBoundingClientRect().height, i = r + I(e);
            i < n ? (l.push(e), d.push(i), c.push(r)) : u += i
        }), t && (e -= u, s = Math.floor(e / l.length), a = Math.floor(e - s * (l.length - 1))), l.forEach(function (e, t) {
            var n = t === l.length - 1 ? a : s, r = d[t], i = n - (r - c[t]);
            r < n && (e.style.height = i + "px")
        })
    }, e.elementClosest = c, e.elementMatches = u, e.enableCursor = function () {
        document.body.classList.remove("fc-not-allowed")
    }, e.eventTupleToStore = ke, e.filterEventStoreDefs = Oe, e.filterHash = we, e.findChildren = function (e, t) {
        for (var n = e instanceof HTMLElement ? [e] : e, r = [], i = 0; i < n.length; i++) for (var o = n[i].children, s = 0; s < o.length; s++) {
            var a = o[s];
            t && !u(a, t) || r.push(a)
        }
        return r
    }, e.findElements = p, e.flexibleCompare = se, e.forceClassName = function (e, t, n) {
        n ? e.classList.add(t) : e.classList.remove(t)
    }, e.formatDate = function (e, t) {
        void 0 === t && (t = {});
        var n = hi(t), r = ot(t), i = n.createMarkerMeta(e);
        ...
        var r = hi("object" == typeof n && n ? n : {}), i = ot(n, An.defaultRangeSeparator), o = r.createMarkerMeta(e),
    ...
    }, e.getClippingParents = k, e.getDayClasses = Qt, e.getElSeg = vt, e.getRectCenter = function (e) {
        return {left: (e.left + e.right) / 2, top: (e.top + e.bottom) / 2}
    }, e.getRelevantEvents = Me, e.globalDefaults = An, e.greatestDurationDenominator = te, e.hasBgRendering = function (e) {
        return "background" === e.rendering || "inverse-background" === e.rendering
    }, e.htmlEscape = xt, e.htmlToElement = E,e.insertAfterElement = function (e, t) {
        for (var n = l(t), r = e.nextSibling || null, i = 0; i < n.length; i++) e.parentNode.insertBefore(n[i], r)
    },e.interactionSettingsStore = Vr,e.interactionSettingsToStore = function (e) {
        var t = {};
        return t[e.component.uid] = e, t
    },e.intersectRanges = Le,e.intersectRects = g,e.isArraysEqual = Ue,e.isDateSpansEqual = function (e, t) {
        return Be(e.range, t.range) && e.allDay === t.allDay && function (e, t) {
            for (var n in t) if ("range" !== n && "allDay" !== n && e[n] !== t[n]) return !1;
            for (var n in e) if (!(n in t)) return !1;
            return !0
        }(e, t)
    },e.isInt = de,e.isInteractionValid = Tt,e.isMultiDayRange = function (e) {
        var t = ve(e);
        return 1 < z(t.start, t.end)
    },e.isPropsEqual = Re,e.isPropsValid = Rt,e.isSingleDay = function (e) {
        return 0 === e.years && 0 === e.months && 1 === e.days && 0 === e.milliseconds
    },e.isValidDate = j,e.listenBySelector = M,e.mapHash = De,e.matchCellWidths = function (e) {
        var r = 0;
        return e.forEach(function (e) {
            var t, n = e.firstChild;
            n instanceof HTMLElement && (t = n.getBoundingClientRect().width, r < t && (r = t))
        }), r++, e.forEach(function (e) {
            e.style.width = r + "px"
        }), r
    },e.memoize = Ae,e.memoizeOutput = We,e.memoizeRendering = Zt,e.mergeEventStores = _e,e.multiplyDuration = function (e, t) {
        return {years: e.years * t, months: e.months * t, days: e.days * t, milliseconds: e.milliseconds * t}
    },e.padStart = le,e.parseBusinessHours = jt,e.parseDragMeta = function (e) {
        var t = {}, n = he(e, fi, vi, t);
        return n.leftoverProps = t, n
    },e.parseEventDef = Ut,e.parseFieldSpecs = re,e.parseMarker = ir,e.pointInsideRect = function (e, t) {
        return e.left >= t.left && e.left < t.right && e.top >= t.top && e.top < t.bottom
    },e.prependToElement = m,e.preventContextMenu = function (e) {
        e.addEventListener("contextmenu", x)
    },e.preventDefault = x,e.preventSelection = function (e) {
        e.classList.add("fc-unselectable"), e.addEventListener("selectstart", x)
    },e.processScopedUiProps = Ot,e.rangeContainsMarker = Ge,e.rangeContainsRange = Fe,e.rangesEqual = Be,e.rangesIntersect = Ve,e.refineProps = he,e.removeElement = r,e.removeExact = function (e, t) {
        for (var n = 0, r = 0; r < e.length;) e[r] === t ? (e.splice(r, 1), n++) : r++;
        return n
    },e.renderDateCell = mi,e.requestJson = Ln,e.sliceEventStore = ht,e.startOfDay = V,e.subtractInnerElHeight = function (e, t) {
        ...
        f(e, {marginLeft: "", marginRight: "", borderLeftWidth: "", borderRightWidth: ""})
    },e.undistributeHeight = ne,e.unpromisify = $t,e.version = "4.4.2",e.whenTransitionDone = function (t, n) {
        var r = function (e) {
    ...
    }, n = (t(i, d = R.DateProfileGenerator), i.prototype.buildRenderRange = function (e, t, n) {
        var r, i, o = this.dateEnv, s = d.prototype.buildRenderRange.call(this, e, t, n), a = s.start, l = s.end;
        return /^(year|month)$/.test(t) && (a = o.startOfWeek(a), (r = o.startOfWeek(l)).valueOf() !== l.valueOf() && (l = R.addWeeks(r, 1))), this.options.monthMode && this.options.fixedWeekCount && (i = Math.ceil(R.diffWeeks(a, l)), l = R.addWeeks(l, 6 - i)), {
            start: a,
            end: l
        }
    }, i);
    ...
    var f = (o.prototype.show = function () {
        ...
        var t = this, e = this.options, n = this.el = R.createElement("div", {
            className: "fc-popover " + (e.className || ""),
            style: {top: "0", left: "0"}
        });
        "function" == typeof e.content && e.content(n), e.parentEl.appendChild(n), R.listenBySelector(n, "click", ".fc-close", function (e) {
            t.hide()
        ...
        var e = this.options, t = this.el, n = t.getBoundingClientRect(), r = R.computeRect(t.offsetParent),
            i = R.computeClippingRect(e.parentEl), o = e.top || 0,
            s = void 0 !== e.left ? e.left : void 0 !== e.right ? e.right - n.width : 0;
        o = Math.min(o, i.bottom - n.height - this.margin), o = Math.max(o, i.top + this.margin), s = Math.min(s, i.right - n.width - this.margin), s = Math.max(s, i.left + this.margin), R.applyStyle(t, {
            top: o - r.top,
            left: s - r.left
        })
    ...
    var s, a = (t(l, s = R.FgEventRenderer), l.prototype.renderSegHtml = function (e, t) {
        var n, r, i = this.context, o = e.eventRange, s = o.def, a = o.ui, l = s.allDay,
            d = R.computeEventDraggable(i, s, a), c = l && e.isStart && R.computeEventStartResizable(i, s, a),
            u = l && e.isEnd && R.computeEventEndResizable(i, s, a), p = this.getSegClasses(e, d, c || u, t),
            h = R.cssToStr(this.getSkinCss(a)), f = "";
        return p.unshift("fc-day-grid-event", "fc-h-event"), e.isStart && (n = this.getTimeText(o)) && (f = '<span class="fc-time">' + R.htmlEscape(n) + "</span>"), r = '<span class="fc-title">' + (R.htmlEscape(s.title || "") || "&nbsp;") + "</span>", '<a class="' + p.join(" ") + '"' + (s.url ? ' href="' + R.htmlEscape(s.url) + '"' : "") + (h ? ' style="' + h + '"' : "") + '><div class="fc-content">' + ("rtl" === i.options.dir ? r + " " + f : f + " " + r) + "</div>" + (c ? '<div class="fc-resizer fc-start-resizer"></div>' : "") + (u ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
    ...
    var u, p = (t(h, u = a), h.prototype.attachSegs = function (e, t) {
        ...
        for (var e, t = this.rowStructs || []; e = t.pop();) R.removeElement(e.tbodyEl);
        this.rowStructs = null
    }, h.prototype.renderSegRows = function (e) {
        for (var t = [], n = this.groupSegRows(e), r = 0; r < n.length; r++) t.push(this.renderSegRow(r, n[r]));
        return t
    }, h.prototype.renderSegRow = function (e, t) {
        var n, r, i, o, s, a, l, d = this.context.isRtl, c = this.dayGrid, u = c.colCnt, p = this.buildSegLevels(t),
            h = Math.max(1, p.length), f = document.createElement("tbody"), v = [], g = [], m = [];

        function y(e) {
            for (; i < e;) (l = (m[n - 1] || [])[i]) ? l.rowSpan = (l.rowSpan || 1) + 1 : (l = document.createElement("td"), o.appendChild(l)), g[n][i] = l, m[n][i] = l, i++
        }

        for (n = 0; n < h; n++) {
            if (r = p[n], i = 0, o = document.createElement("tr"), v.push([]), g.push([]), m.push([]), r) for (s = 0; s < r.length; s++) {
                a = r[s];
                var S = d ? u - 1 - a.lastCol : a.firstCol, E = d ? u - 1 - a.firstCol : a.lastCol;
                for (y(S), l = R.createElement("td", {className: "fc-event-container"}, a.el), S !== E ? l.colSpan = E - S + 1 : m[n][i] = l; i <= E;) g[n][i] = l, v[n][i] = a, i++;
                o.appendChild(l)
            }
            y(u);
            var b = c.renderProps.renderIntroHtml();
            b && (d ? R.appendToElement(o, b) : R.prependToElement(o, b)), f.appendChild(o)
        }
        return {row: e, tbodyEl: f, cellMatrix: g, segMatrix: v, segLevels: p, segs: t}
        ...
        for (e = this.sortEventSegs(e), t = 0; t < e.length; t++) {
            for (n = e[t], r = 0; r < s.length && function (e, t) {
                var n, r;
                for (n = 0; n < t.length; n++) if ((r = t[n]).firstCol <= e.lastCol && r.lastCol >= e.firstCol) return 1
            }(n, s[r]); r++) ;
            n.level = r, n.leftCol = i ? o - 1 - n.lastCol : n.firstCol, n.rightCol = i ? o - 1 - n.firstCol : n.lastCol, (s[r] || (s[r] = [])).push(n)
        }
    ...
    var g, m = (t(y, g = p), y.prototype.attachSegs = function (e, t) {
        var o = t.sourceSeg, s = this.rowStructs = this.renderSegRows(e);
        this.dayGrid.rowEls.forEach(function (e, t) {
            var n = R.htmlToElement('<div class="fc-mirror-skeleton"><table></table></div>'),
                r = o && o.row === t ? o.el : (r = e.querySelector(".fc-content-skeleton tbody")) || e.querySelector(".fc-content-skeleton table"),
                i = r.getBoundingClientRect().top - e.getBoundingClientRect().top;
            n.style.top = i + "px", n.querySelector("table").appendChild(s[t].tbodyEl), e.appendChild(n)
        })
    }, y);
    ...
    var S, E = '<td style="pointer-events:none"></td>',
        b = (t(w, S = R.FillRenderer), w.prototype.renderSegs = function (e, t, n) {
            "bgEvent" === e && (n = n.filter(function (e) {
                return e.eventRange.def.allDay
            })), S.prototype.renderSegs.call(this, e, t, n)
        }, w.prototype.attachSegs = function (e, t) {
            for (var n, r, i = [], o = 0; o < t.length; o++) n = t[o], r = this.renderFillRow(e, n), this.dayGrid.rowEls[n.row].appendChild(r), i.push(r);
            return i
        }, w.prototype.renderFillRow = function (e, t) {
            var n = this.dayGrid, r = this.context.isRtl, i = n.colCnt, o = r ? i - 1 - t.lastCol : t.firstCol,
                s = (r ? i - 1 - t.firstCol : t.lastCol) + 1, a = "businessHours" === e ? "bgevent" : e.toLowerCase(),
                l = R.htmlToElement('<div class="fc-' + a + '-skeleton"><table><tr></tr></table></div>'),
                d = l.getElementsByTagName("tr")[0];
            0 < o && R.appendToElement(d, new Array(o + 1).join(E)), t.el.colSpan = s - o, d.appendChild(t.el), s < i && R.appendToElement(d, new Array(i - s + 1).join(E));
            var c = n.renderProps.renderIntroHtml();
            return c && (r ? R.appendToElement(d, c) : R.prependToElement(d, c)), l
        }, w);
    ...
    var D, T = (t(C, D = R.DateComponent), C.prototype.firstContext = function (e) {
        ...
        D.prototype.destroy.call(this), this.renderFrame.unrender(), this.context.calendar.unregisterInteractiveComponent(this)
    }, C.prototype._renderFrame = function (e) {
        var t = this.context, n = t.theme, r = t.dateEnv, i = t.options,
            o = r.format(e, R.createFormatter(i.dayPopoverFormat));
        this.el.innerHTML = '<div class="fc-header ' + n.getClass("popoverHeader") + '"><span class="fc-title">' + R.htmlEscape(o) + '</span><span class="fc-close ' + n.getIconClass("close") + '"></span></div><div class="fc-body ' + n.getClass("popoverContent") + '"><div class="fc-event-container"></div></div>', this.segContainerEl = this.el.querySelector(".fc-event-container")
    }, C.prototype.queryHit = function (e, t, n, r) {
        var i = this.props.date;
        if (e < n && t < r) return {
            component: this,
            dateSpan: {allDay: !0, range: {start: i, end: R.addDays(i, 1)}},
            dayEl: this.el,
    ...
    var M = (P.prototype.renderHtml = function (e) {
        var t = [];
        e.renderIntroHtml && t.push(e.renderIntroHtml());
        for (var n, r, i, o, s, a, l, d, c = 0, u = e.cells; c < u.length; c++) {
            var p = u[c];
            t.push((n = p.date, r = e.dateProfile, i = this.context, o = p.htmlAttrs, d = l = a = s = void 0, s = i.dateEnv, a = i.theme, l = R.rangeContainsMarker(r.activeRange, n), (d = R.getDayClasses(n, r, i)).unshift("fc-day", a.getClass("widgetContent")), '<td class="' + d.join(" ") + '"' + (l ? ' data-date="' + s.formatIso(n, {omitTime: !0}) + '"' : "") + (o ? " " + o : "") + "></td>"))
        }
    ...
    var H, _ = R.createFormatter({day: "numeric"}), O = R.createFormatter({week: "numeric"}),
        z = (t(N, H = R.DateComponent), N.prototype.render = function (e, t) {
            var n = e.cells;
            ...
            for (var n, r = this.context, i = r.calendar, o = r.view, s = r.isRtl, a = r.dateEnv, l = this.rowCnt, d = this.colCnt, c = "", u = 0; u < l; u++) c += this.renderDayRowHtml(u, t);
            for (this.el.innerHTML = c, this.rowEls = R.findElements(this.el, ".fc-row"), this.cellEls = R.findElements(this.el, ".fc-day, .fc-disabled-day"), s && this.cellEls.reverse(), this.rowPositions = new R.PositionCache(this.el, this.rowEls, !1, !0), this.colPositions = new R.PositionCache(this.el, this.cellEls.slice(0, d), !0, !1), u = 0; u < l; u++) for (n = 0; n < d; n++) i.publiclyTrigger("dayRender", [{
            ...
            var n = this.context.theme, r = ["fc-row", "fc-week", n.getClass("dayRow")];
            t && r.push("fc-rigid");
            ...
            var t = this.context.isRtl, n = this.renderProps.renderNumberIntroHtml(e, this);
            return "<tr>" + (t ? "" : n) + this.renderNumberCellsHtml(e) + (t ? n : "") + "</tr>"
        }, N.prototype.renderNumberCellsHtml = function (e) {
            for (var t, n = [], r = 0; r < this.colCnt; r++) t = this.props.cells[e][r].date, n.push(this.renderNumberCellHtml(t));
            return this.context.isRtl && n.reverse(), n.join("")
        }, N.prototype.renderNumberCellHtml = function (e) {
            var t, n, r = this.context, i = r.dateEnv, o = r.options, s = "",
                a = R.rangeContainsMarker(this.props.dateProfile.activeRange, e),
                l = this.getIsDayNumbersVisible() && a;
            return l || this.renderProps.cellWeekNumbersVisible ? ((t = R.getDayClasses(e, this.props.dateProfile, this.context)).unshift("fc-day-top"), this.renderProps.cellWeekNumbersVisible && (n = i.weekDow), s += '<td class="' + t.join(" ") + '"' + (a ? ' data-date="' + i.formatIso(e, {omitTime: !0}) + '"' : "") + ">", this.renderProps.cellWeekNumbersVisible && e.getUTCDay() === n && (s += R.buildGotoAnchorHtml(o, i, {
                date: e,
                type: "week"
            }, {class: "fc-week-number"}, i.format(e, O))), l && (s += R.buildGotoAnchorHtml(o, i, e, {class: "fc-day-number"}, i.format(e, _))), s += "</td>") : "<td></td>"
        }, N.prototype.updateSize = function (e) {
            var t = this.context.calendar, n = this.fillRenderer, r = this.eventRenderer, i = this.mirrorRenderer;
            (e || this.isCellSizesDirty || t.isEventsUpdated) && (this.buildPositionCaches(), this.isCellSizesDirty = !1), n.computeSizes(e), r.computeSizes(e), i.computeSizes(e), n.assignSizes(e), r.assignSizes(e), i.assignSizes(e)
            ...
            if (null != o && null != i) return {
                ...
                relativeRect: {left: n.lefts[i], right: n.rights[i], top: r.tops[o], bottom: r.bottoms[o]}
            }
            ...
            for (var t, n = this.eventRenderer.rowStructs || [], r = 0; r < n.length; r++) this.unlimitRow(r), !1 !== (t = !!e && ("number" == typeof e ? e : this.computeRowLevelLimit(r))) && this.limitRow(r, t)
        }, N.prototype.computeRowLevelLimit = function (e) {
            for (var t, n = this.rowEls[e].getBoundingClientRect().bottom, r = R.findChildren(this.eventRenderer.rowStructs[e].tbodyEl), i = 0; i < r.length; i++) if ((t = r[i]).classList.remove("fc-limited"), t.getBoundingClientRect().bottom > n) return i;
            return !1
        }, N.prototype.limitRow = function (t, n) {
            function e(e) {
                for (; D < e;) (l = y.getCellSegs(t, D, n)).length && (u = i[n - 1][D], m = y.renderMoreLink(t, D, l), g = R.createElement("div", null, m), u.appendChild(g), w.push(g)), D++
            }

            var r, i, o, s, a, l, d, c, u, p, h, f, v, g, m, y = this, S = this.colCnt, E = this.context.isRtl,
                b = this.eventRenderer.rowStructs[t], w = [], D = 0;
            if (n && n < b.segLevels.length) {
                for (r = b.segLevels[n - 1], i = b.cellMatrix, (o = R.findChildren(b.tbodyEl).slice(n)).forEach(function (e) {
                    e.classList.add("fc-limited")
                }), s = 0; s < r.length; s++) {
                    a = r[s];
                    var T = E ? S - 1 - a.lastCol : a.firstCol, C = E ? S - 1 - a.firstCol : a.lastCol;
                    for (e(T), c = [], d = 0; D <= C;) l = this.getCellSegs(t, D, n), c.push(l), d += l.length, D++;
                    if (d) {
                        for (p = (u = i[n - 1][T]).rowSpan || 1, h = [], f = 0; f < c.length; f++) v = R.createElement("td", {
                            className: "fc-more-cell",
                            rowSpan: p
                        }), l = c[f], m = this.renderMoreLink(t, T + f, [a].concat(l)), g = R.createElement("div", null, m), v.appendChild(g), h.push(v), w.push(v);
                        u.classList.add("fc-limited"), R.insertAfterElement(u, h), o.push(u)
                    }
                }
            ...
            t.moreEls && (t.moreEls.forEach(R.removeElement), t.moreEls = null), t.limitedEls && (t.limitedEls.forEach(function (e) {
                e.classList.remove("fc-limited")
            }), t.limitedEls = null)
        }, N.prototype.renderMoreLink = function (d, c, u) {
            var p = this, e = this.context, h = e.calendar, f = e.view, v = e.dateEnv, g = e.options, m = e.isRtl,
                t = R.createElement("a", {className: "fc-more"});
            return t.innerText = this.getMoreLinkText(u.length), t.addEventListener("click", function (e) {
                var t = g.eventLimitClick, n = m ? p.colCnt - c - 1 : c, r = p.props.cells[d][n].date,
                    i = e.currentTarget, o = p.getCellEl(d, c), s = p.getCellSegs(d, c), a = p.resliceDaySegs(s, r),
                    l = p.resliceDaySegs(u, r);
                "function" == typeof t && (t = h.publiclyTrigger("eventLimitClick", [{
                    date: v.toDate(r),
                    allDay: !0,
                    dayEl: o,
                    moreEl: i,
                    ...
                    jsEvent: e,
                    view: f
                }])), "popover" === t ? p.showSegPopover(d, c, i, a) : "string" == typeof t && h.zoomTo(r, t)
            }), t
        }, N.prototype.showSegPopover = function (t, e, n, r) {
            var i = this, o = this.context, s = o.calendar, a = o.view, l = o.theme, d = o.isRtl,
                c = d ? this.colCnt - e - 1 : e, u = n.parentNode, p = 1 === this.rowCnt ? a.el : this.rowEls[t], h = {
                    className: "fc-more-popover " + l.getClass("popover"),
                    parentEl: a.el,
                    top: R.computeRect(p).top,
                    autoHide: !0,
                    content: function (e) {
                        i.segPopoverTile = new T(e), i.updateSegPopoverTile(i.props.cells[t][c].date, r)
                    },
                    hide: function () {
                        i.segPopoverTile.destroy(), i.segPopoverTile = null, i.segPopover.destroy(), i.segPopover = null
                    }
                };
            d ? h.right = R.computeRect(u).right + 1 : h.left = R.computeRect(u).left - 1, this.segPopover = new f(h), this.segPopover.show(), s.releaseAfterSizingTriggers()
        }, N.prototype.resliceDaySegs = function (e, t) {
            for (var n = {start: t, end: R.addDays(t, 1)}, r = [], i = 0, o = e; i < o.length; i++) {
                var s = o[i], a = s.eventRange, l = a.range, d = R.intersectRanges(l, n);
                d && r.push(c({}, s, {
                    eventRange: {
                        def: a.def,
    ...
    var L, B = R.createFormatter({week: "numeric"}), V = (t(F, L = R.View), F.prototype._processOptions = function (e) {
        ...
        L.prototype.render.call(this, e, t), this.processOptions(t.options), this.renderSkeleton(t)
    }, F.prototype.destroy = function () {
        L.prototype.destroy.call(this), this.renderSkeleton.unrender()
    }, F.prototype._renderSkeleton = function (e) {
        this.el.classList.add("fc-dayGrid-view"), this.el.innerHTML = this.renderSkeletonHtml(), this.scroller = new R.ScrollComponent("hidden", "auto");
        ...
        t.appendChild(n), this.dayGrid = new z(n, {
        ...
        var e = this.context, t = e.theme, n = e.options;
        ...
        L.prototype.updateSize.call(this, e, t, n), this.dayGrid.updateSize(e)
    }, F.prototype.updateBaseSize = function (e, t, n) {
        var r, i, o = this.dayGrid, s = this.context.options.eventLimit, a = this.header ? this.header.el : null;
        ...
        this.context.options.monthMode ? (t && (e *= this.dayGrid.rowCnt / 6), R.distributeHeight(this.dayGrid.rowEls, e, !t)) : t ? R.undistributeHeight(this.dayGrid.rowEls) : R.distributeHeight(this.dayGrid.rowEls, e, !0)
    ...
    function F() {
        ...
        return s.processOptions = R.memoize(s._processOptions), s.renderSkeleton = R.memoizeRendering(s._renderSkeleton, s._unrenderSkeleton), s.renderHeadIntroHtml = function () {
            var e = s.context, t = e.theme, n = e.options;
            return s.colWeekNumbersVisible ? '<th class="fc-week-number ' + t.getClass("widgetHeader") + '" ' + s.weekNumberStyleAttr() + "><span>" + R.htmlEscape(n.weekLabel) + "</span></th>" : ""
        }, s.renderDayGridNumberIntroHtml = function (e, t) {
            var n = s.context, r = n.options, i = n.dateEnv, o = t.props.cells[e][0].date;
            return s.colWeekNumbersVisible ? '<td class="fc-week-number" ' + s.weekNumberStyleAttr() + ">" + R.buildGotoAnchorHtml(r, i, {
                date: o,
                type: "week",
                forceOff: 1 === t.colCnt
            }, i.format(o, B)) + "</td>" : ""
    ...
    var G, U = (t(A, G = R.DateComponent), A.prototype.firstContext = function (e) {
        e.calendar.registerInteractiveComponent(this, {el: this.dayGrid.el})
    }, A.prototype.destroy = function () {
        G.prototype.destroy.call(this), this.context.calendar.unregisterInteractiveComponent(this)
    }, A.prototype.render = function (e, t) {
        var n = this.dayGrid, r = e.dateProfile, i = e.dayTable;
        n.receiveContext(t), n.receiveProps(c({}, this.slicer.sliceProps(e, r, e.nextDayThreshold, t.calendar, n, i), {
            dateProfile: r,
            cells: i.cells,
            isRigid: e.isRigid
        }), t)
    ...
    var W, j = (t(Z, W = R.Slicer), Z.prototype.sliceRange = function (e, t) {
    ...
    var q, Y = (t(X, q = V), X.prototype.render = function (e, t) {
        q.prototype.render.call(this, e, t);
        var n = this.props.dateProfile, r = this.dayTable = this.buildDayTable(n, e.dateProfileGenerator);
        this.header && this.header.receiveProps({
            dateProfile: n,
            dates: r.headerDates,
            datesRepDistinctDays: 1 === r.rowCnt,
            renderIntroHtml: this.renderHeadIntroHtml
        }, t), this.simpleDayGrid.receiveProps({
            dateProfile: n,
            dayTable: r,
        ...
        q.prototype._renderSkeleton.call(this, e), e.options.columnHeader && (this.header = new R.DayHeader(this.el.querySelector(".fc-head-container"))), this.simpleDayGrid = new U(this.dayGrid)
    }, X.prototype._unrenderSkeleton = function () {
        q.prototype._unrenderSkeleton.call(this), this.header && this.header.destroy(), this.simpleDayGrid.destroy()
    }, X);
    ...
    e.AbstractDayGridView = V, e.DayBgRow = M, e.DayGrid = z, e.DayGridSlicer = j, e.DayGridView = Y, e.SimpleDayGrid = U, e.buildBasicDayTable = K, e.default = J, Object.defineProperty(e, "__esModule", {value: !0})
}), function (e, t) {
    ...
    var n, i = (t(o, n = p.FgEventRenderer), o.prototype.attachSegs = function (e) {
        ...
        var t = this.context, n = t.theme, r = t.options, i = e.eventRange, o = i.def, s = i.instance, a = i.ui,
            l = o.url, d = ["fc-list-item"].concat(a.classNames), c = a.backgroundColor,
            u = o.allDay ? p.getAllDayHtml(r) : p.isMultiDayRange(i.range) ? e.isStart ? p.htmlEscape(this._getTimeText(s.range.start, e.end, !1)) : e.isEnd ? p.htmlEscape(this._getTimeText(e.start, s.range.end, !1)) : p.getAllDayHtml(r) : p.htmlEscape(this.getTimeText(i));
        return l && d.push("fc-has-url"), '<tr class="' + d.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + n.getClass("widgetContent") + '">' + (u || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + n.getClass("widgetContent") + '"><span class="fc-event-dot"' + (c ? ' style="background-color:' + c + '"' : "") + '></span></td><td class="fc-list-item-title ' + n.getClass("widgetContent") + '"><a' + (l ? ' href="' + p.htmlEscape(l) + '"' : "") + ">" + p.htmlEscape(o.title || "") + "</a></td></tr>"
    ...
    var s, a = (t(l, s = p.View), l.prototype.firstContext = function (e) {
        e.calendar.registerInteractiveComponent(this, {el: this.el})
    }, l.prototype.render = function (e, t) {
        s.prototype.render.call(this, e, t);
        var n = this.computeDateVars(e.dateProfile), r = n.dayDates, i = n.dayRanges;
        this.dayDates = r, this.renderSkeleton(t), this.renderContent(t, this.eventStoreToSegs(e.eventStore, e.eventUiBases, i))
    }, l.prototype.destroy = function () {
        s.prototype.destroy.call(this), this.renderSkeleton.unrender(), this.renderContent.unrender(), this.context.calendar.unregisterInteractiveComponent(this)
    }, l.prototype._renderSkeleton = function (e) {
        var t = e.theme;
        this.el.classList.add("fc-list-view");
        for (var n = 0, r = (t.getClass("listView") || "").split(" "); n < r.length; n++) {
            var i = r[n];
            i && this.el.classList.add(i)
        }
        this.scroller = new p.ScrollComponent("hidden", "auto"), this.el.appendChild(this.scroller.el), this.contentEl = this.scroller.el
    }, l.prototype._unrenderSkeleton = function () {
        this.scroller.destroy()
    }, l.prototype.updateSize = function (e, t, n) {
        s.prototype.updateSize.call(this, e, t, n), this.eventRenderer.computeSizes(e), this.eventRenderer.assignSizes(e), this.scroller.clear(), n || this.scroller.setHeight(this.computeScrollerHeight(t))
        ...
        return this.eventRangesToSegs(p.sliceEventStore(e, t, this.props.dateProfile.activeRange, this.context.nextDayThreshold).fg, n)
        ...
        for (var n, r, i = this.context, o = i.dateEnv, s = i.nextDayThreshold, a = e.range, l = e.def.allDay, d = [], c = 0; c < t.length; c++) if ((n = p.intersectRanges(a, t[c])) && (r = {
            component: this,
            eventRange: e,
            start: n.start,
            end: n.end,
            ...
            dayIndex: c
        }, d.push(r), !r.isEnd && !l && c + 1 < t.length && a.end < o.add(t[c + 1].start, s))) {
            r.end = a.end, r.isEnd = !0;
            break
        }
        return d
    }, l.prototype.renderEmptyMessage = function () {
        this.contentEl.innerHTML = '<div class="fc-list-empty-wrap2"><div class="fc-list-empty-wrap1"><div class="fc-list-empty">' + p.htmlEscape(this.context.options.noEventsMessage) + "</div></div></div>"
    }, l.prototype.renderSegList = function (e) {
        for (var t, n, r = this.context.theme, i = this.groupSegsByDay(e), o = p.htmlToElement('<table class="fc-list-table ' + r.getClass("tableList") + '"><tbody></tbody></table>'), s = o.querySelector("tbody"), a = 0; a < i.length; a++) if (t = i[a]) for (s.appendChild(this.buildDayHeaderRow(this.dayDates[a])), t = this.eventRenderer.sortEventSegs(t), n = 0; n < t.length; n++) s.appendChild(t[n].el);
        this.contentEl.innerHTML = "", this.contentEl.appendChild(o)
    }, l.prototype.groupSegsByDay = function (e) {
        for (var t, n = [], r = 0; r < e.length; r++) (n[(t = e[r]).dayIndex] || (n[t.dayIndex] = [])).push(t);
        return n
    }, l.prototype.buildDayHeaderRow = function (e) {
        var t = this.context, n = t.theme, r = t.dateEnv, i = t.options, o = p.createFormatter(i.listDayFormat),
            s = p.createFormatter(i.listDayAltFormat);
        return p.createElement("tr", {
            className: "fc-list-heading",
            "data-date": r.formatIso(e, {omitTime: !0})
        }, '<td class="' + (n.getClass("tableListHeading") || n.getClass("widgetHeader")) + '" colspan="3">' + (o ? p.buildGotoAnchorHtml(i, r, e, {class: "fc-list-heading-main"}, p.htmlEscape(r.format(e, o))) : "") + (s ? p.buildGotoAnchorHtml(i, r, e, {class: "fc-list-heading-alt"}, p.htmlEscape(r.format(e, s))) : "") + "</td>")
    }, l);

    function l(e, t) {
        var n = s.call(this, e, t) || this;
        n.computeDateVars = p.memoize(d), n.eventStoreToSegs = p.memoize(n._eventStoreToSegs), n.renderSkeleton = p.memoizeRendering(n._renderSkeleton, n._unrenderSkeleton);
        var r = n.eventRenderer = new i(n);
        return n.renderContent = p.memoizeRendering(r.renderSegs.bind(r), r.unrender.bind(r), [n.renderSkeleton]), n
    }

    function d(e) {
        for (var t = p.startOfDay(e.renderRange.start), n = e.renderRange.end, r = [], i = []; t < n;) r.push(t), i.push({
            start: t,
            end: p.addDays(t, 1)
        }), t = p.addDays(t, 1);
    ...
    e.ListView = a, e.default = c, Object.defineProperty(e, "__esModule", {value: !0})
}), function (e, t) {
    ...
    var i, l = function () {
    ...
    }, s = (t(n, i = g.FgEventRenderer), n.prototype.renderSegs = function (e, t, n) {
        i.prototype.renderSegs.call(this, e, t, n), this.fullTimeFormat = g.createFormatter({
            hour: "numeric",
            minute: "2-digit",
        ...
        var t = this.timeGrid, n = this.segsByCol, r = t.colCnt;
        if (t.computeSegVerticals(e), n) for (var i = 0; i < r; i++) this.computeSegHorizontals(n[i])
    }, n.prototype.assignSegSizes = function (e) {
        var t = this.timeGrid, n = this.segsByCol, r = t.colCnt;
        if (t.assignSegVerticals(e), n) for (var i = 0; i < r; i++) this.assignSegCss(n[i])
        ...
        var n, r, i, o, s, a = e.eventRange, l = a.def, d = a.ui, c = l.allDay,
            u = g.computeEventDraggable(this.context, l, d),
            p = e.isStart && g.computeEventStartResizable(this.context, l, d),
            h = e.isEnd && g.computeEventEndResizable(this.context, l, d), f = this.getSegClasses(e, u, p || h, t),
            v = g.cssToStr(this.getSkinCss(d));
        return f.unshift("fc-time-grid-event"), g.isMultiDayRange(a.range) ? (e.isStart || e.isEnd) && (n = e.start, r = e.end, i = this._getTimeText(n, r, c), o = this._getTimeText(n, r, c, this.fullTimeFormat), s = this._getTimeText(n, r, c, null, !1)) : (i = this.getTimeText(a), o = this.getTimeText(a, this.fullTimeFormat), s = this.getTimeText(a, null, !1)), '<a class="' + f.join(" ") + '"' + (l.url ? ' href="' + g.htmlEscape(l.url) + '"' : "") + (v ? ' style="' + v + '"' : "") + '><div class="fc-content">' + (i ? '<div class="fc-time" data-start="' + g.htmlEscape(s) + '" data-full="' + g.htmlEscape(o) + '"><span>' + g.htmlEscape(i) + "</span></div>" : "") + (l.title ? '<div class="fc-title">' + g.htmlEscape(l.title) + "</div>" : "") + "</div>" + (h ? '<div class="fc-resizer fc-end-resizer"></div>' : "") + "</a>"
        ...
        if (function (e) {
            var t, n, r, i, o;
            for (t = 0; t < e.length; t++) for (n = e[t], r = 0; r < n.length; r++) for ((i = n[r]).forwardSegs = [], o = t + 1; o < e.length; o++) a(i, e[o], i.forwardSegs)
        }(r), t = r[0]) {
            for (n = 0; n < t.length; n++) !function e(t) {
                var n, r, i = t.forwardSegs, o = 0;
                if (void 0 === t.forwardPressure) {
                    for (n = 0; n < i.length; n++) r = i[n], e(r), o = Math.max(o, 1 + r.forwardPressure);
                    t.forwardPressure = o
                }
            }(t[n]);
            for (n = 0; n < t.length; n++) this.computeSegForwardBack(t[n], 0, 0)
        }
        ...
        var t = e.map(o), n = [{field: "forwardPressure", order: -1}, {
            field: "backwardCoord",
            order: 1
        ...
        for (var t = 0, n = e; t < n.length; t++) {
            var r = n[t];
            g.applyStyle(r.el, this.generateSegCss(r)), 0 < r.level && r.el.classList.add("fc-time-grid-event-inset"), r.eventRange.def.title && r.bottom - r.top < 30 && r.el.classList.add("fc-short")
        }
        ...
        return r && (o = Math.min(1, i + 2 * (o - i))), n = a ? (t = 1 - o, i) : (t = i, 1 - o), s.zIndex = e.level + 1, s.left = 100 * t + "%", s.right = 100 * n + "%", r && e.forwardPressure && (s[a ? "marginLeft" : "marginRight"] = 20), s
    }, n);
    ...
    function a(e, t, n) {
        void 0 === n && (n = []);
        for (var r, i, o = 0; o < t.length; o++) r = e, i = t[o], r.bottom > i.top && r.top < i.bottom && n.push(t[o]);
        return n
    }
    ...
    var d, u = (t(p, d = s), p.prototype.attachSegs = function (e, t) {
        ...
        var t, n = d.prototype.generateSegCss.call(this, e), r = this.sourceSeg;
        return r && r.col === e.col && (t = d.prototype.generateSegCss.call(this, r), n.left = t.left, n.right = t.right, n.marginLeft = t.marginLeft, n.marginRight = t.marginRight), n
    }, p);
    ...
    var h, f = (t(v, h = g.FillRenderer), v.prototype.attachSegs = function (e, t) {
    ...
    var m, y = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}],
        S = (t(E, m = g.DateComponent), E.prototype._processOptions = function (e) {
            var t, n = e.slotDuration, r = e.snapDuration, n = g.createDuration(n), r = r ? g.createDuration(r) : n,
                i = g.wholeDivideDurations(n, r);
            null === i && (r = n, i = 1), this.slotDuration = n, this.snapDuration = r, this.snapsPerSlot = i, t = e.slotLabelFormat, Array.isArray(t) && (t = t[t.length - 1]), this.labelFormat = g.createFormatter(t || {
                hour: "numeric",
                minute: "2-digit",
                omitZeroMinute: !0,
                meridiem: "short"
            }), t = e.slotLabelInterval, this.labelInterval = t ? g.createDuration(t) : this.computeLabelInterval(n)
        }, E.prototype.computeLabelInterval = function (e) {
            for (var t, n, r = y.length - 1; 0 <= r; r--) if (t = g.createDuration(y[r]), null !== (n = g.wholeDivideDurations(t, e)) && 1 < n) return t;
            return e
        }, E.prototype.render = function (e, t) {
            this.processOptions(t.options);
            var n = e.cells;
            this.colCnt = n.length, this.renderSkeleton(t.theme), this.renderSlats(e.dateProfile), this.renderColumns(e.cells, e.dateProfile), this.renderBusinessHours(t, e.businessHourSegs), this.renderDateSelection(e.dateSelectionSegs), this.renderFgEvents(t, e.fgEventSegs), this.renderBgEvents(t, e.bgEventSegs), this.renderEventSelection(e.eventSelection), this.renderEventDrag(e.eventDrag), this.renderEventResize(e.eventResize)
        }, E.prototype.destroy = function () {
            m.prototype.destroy.call(this), this.renderSlats.unrender(), this.renderColumns.unrender(), this.renderSkeleton.unrender()
        }, E.prototype.updateSize = function (e) {
            var t = this.fillRenderer, n = this.eventRenderer, r = this.mirrorRenderer;
            (e || this.isSlatSizesDirty) && (this.buildSlatPositions(), this.isSlatSizesDirty = !1), (e || this.isColSizesDirty) && (this.buildColPositions(), this.isColSizesDirty = !1), t.computeSizes(e), n.computeSizes(e), r.computeSizes(e), t.assignSizes(e), n.assignSizes(e), r.assignSizes(e)
            ...
            this.slatContainerEl.innerHTML = '<table class="' + t.getClass("tableGrid") + '">' + this.renderSlatRowHtml(e) + "</table>", this.slatEls = g.findElements(this.slatContainerEl, "tr"), this.slatPositions = new g.PositionCache(this.el, this.slatEls, !1, !0), this.isSlatSizesDirty = !0
        }, E.prototype.renderSlatRowHtml = function (e) {
            for (var t, n, r, i = this.context, o = i.dateEnv, s = i.theme, a = i.isRtl, l = "", d = g.startOfDay(e.renderRange.start), c = e.minTime, u = g.createDuration(0); g.asRoughMs(c) < g.asRoughMs(e.maxTime);) t = o.add(d, c), n = null !== g.wholeDivideDurations(u, this.labelInterval), r = '<td class="fc-axis fc-time ' + s.getClass("widgetContent") + '">' + (n ? "<span>" + g.htmlEscape(o.format(t, this.labelFormat)) + "</span>" : "") + "</td>", l += '<tr data-time="' + g.formatIsoTimeString(t) + '"' + (n ? "" : ' class="fc-minor"') + ">" + (a ? "" : r) + '<td class="' + s.getClass("widgetContent") + '"></td>' + (a ? r : "") + "</tr>", c = g.addDurations(c, this.slotDuration), u = g.addDurations(u, this.slotDuration);
            return l
        }, E.prototype._renderColumns = function (e, t) {
            var n = this.context, r = n.calendar, i = n.view, o = n.isRtl, s = n.theme, a = n.dateEnv,
                l = new c.DayBgRow(this.context);
            this.rootBgContainerEl.innerHTML = '<table class="' + s.getClass("tableGrid") + '">' + l.renderHtml({
                cells: e,
                dateProfile: t,
                renderIntroHtml: this.renderProps.renderBgIntroHtml
            }) + "</table>", this.colEls = g.findElements(this.el, ".fc-day, .fc-disabled-day");
            for (var d = 0; d < this.colCnt; d++) r.publiclyTrigger("dayRender", [{
                date: a.toDate(e[d].date),
                el: this.colEls[d],
                view: i
            }]);
            o && this.colEls.reverse(), this.colPositions = new g.PositionCache(this.el, this.colEls, !0, !1), this.renderContentSkeleton(), this.isColSizesDirty = !0
        }, E.prototype._unrenderColumns = function () {
            this.unrenderContentSkeleton()
        }, E.prototype.renderContentSkeleton = function () {
            var e, t = this.context.isRtl, n = [];
            ...
            t && n.reverse(), e = this.contentSkeletonEl = g.htmlToElement('<div class="fc-content-skeleton"><table><tr>' + n.join("") + "</tr></table></div>"), this.colContainerEls = g.findElements(e, ".fc-content-col"), this.mirrorContainerEls = g.findElements(e, ".fc-mirror-container"), this.fgContainerEls = g.findElements(e, ".fc-event-container:not(.fc-mirror-container)"), this.bgContainerEls = g.findElements(e, ".fc-bgevent-container"), this.highlightContainerEls = g.findElements(e, ".fc-highlight-container"), this.businessContainerEls = g.findElements(e, ".fc-business-container"), t && (this.colContainerEls.reverse(), this.mirrorContainerEls.reverse(), this.fgContainerEls.reverse(), this.bgContainerEls.reverse(), this.highlightContainerEls.reverse(), this.businessContainerEls.reverse()), this.el.appendChild(e)
            ...
            for (var n, r, i = 0; i < this.colCnt; i++) for (n = e[i], r = 0; r < n.length; r++) t[i].appendChild(n[r].el)
        }, E.prototype.getNowIndicatorUnit = function () {
            return "minute"
        }, E.prototype.renderNowIndicator = function (e, t) {
            if (this.colContainerEls) {
                for (var n, r = this.computeDateTop(t), i = [], o = 0; o < e.length; o++) {
                    var s = g.createElement("div", {className: "fc-now-indicator fc-now-indicator-line"});
                    s.style.top = r + "px", this.colContainerEls[e[o].col].appendChild(s), i.push(s)
                }
                0 < e.length && ((n = g.createElement("div", {className: "fc-now-indicator fc-now-indicator-arrow"})).style.top = r + "px", this.contentSkeletonEl.appendChild(n), i.push(n)), this.nowIndicatorEls = i
            }
        }, E.prototype.unrenderNowIndicator = function () {
            this.nowIndicatorEls && (this.nowIndicatorEls.forEach(g.removeElement), this.nowIndicatorEls = null)
        }, E.prototype.getTotalSlatHeight = function () {
            return this.slatContainerEl.getBoundingClientRect().height
        }, E.prototype.computeDateTop = function (e, t) {
            return t = t || g.startOfDay(e), this.computeTimeTop(g.createDuration(e.valueOf() - t.valueOf()))
        }, E.prototype.computeTimeTop = function (e) {
            var t, n, r = this.slatEls.length, i = this.props.dateProfile,
                o = (e.milliseconds - g.asRoughMs(i.minTime)) / g.asRoughMs(this.slotDuration), o = Math.max(0, o);
            return o = Math.min(r, o), t = Math.floor(o), n = o - (t = Math.min(t, r - 1)), this.slatPositions.tops[t] + this.slatPositions.getHeight(t) * n
        }, E.prototype.computeSegVerticals = function (e) {
            for (var t, n, r = this.context.options.timeGridEventMinHeight, i = 0; i < e.length; i++) t = e[i], n = this.props.cells[t.col].date, t.top = this.computeDateTop(t.start, n), t.bottom = Math.max(t.top + r, this.computeDateTop(t.end, n))
        }, E.prototype.assignSegVerticals = function (e) {
            for (var t, n = 0; n < e.length; n++) t = e[n], g.applyStyle(t.el, this.generateSegVerticalCss(t))
            ...
            var n = this.context.dateEnv, r = this.snapsPerSlot, i = this.slatPositions, o = this.colPositions,
                s = o.leftToIndex(e), a = i.topToIndex(t);
            if (null != s && null != a) {
                var l = i.tops[a], d = i.getHeight(a), c = (t - l) / d, u = a * r + Math.floor(c * r),
                    p = this.props.cells[s].date,
                    h = g.addDurations(this.props.dateProfile.minTime, g.multiplyDuration(this.snapDuration, u)),
                    f = n.add(p, h);
                return {
                    col: s,
                    dateSpan: {range: {start: f, end: n.add(f, this.snapDuration)}, allDay: !1},
                    dayEl: this.colEls[s],
                    relativeRect: {left: o.lefts[s], right: o.rights[s], top: l, bottom: l + d}
                }
            }
    ...
    function E(e, t) {
        ...
        n.isSlatSizesDirty = !1, n.isColSizesDirty = !1, n.processOptions = g.memoize(n._processOptions), n.renderSkeleton = g.memoizeRendering(n._renderSkeleton), n.renderSlats = g.memoizeRendering(n._renderSlats, null, [n.renderSkeleton]), n.renderColumns = g.memoizeRendering(n._renderColumns, n._unrenderColumns, [n.renderSkeleton]), n.renderProps = t;
        var r = n.renderColumns, i = n.eventRenderer = new s(n), o = n.fillRenderer = new f(n);
        return n.mirrorRenderer = new u(n), n.renderBusinessHours = g.memoizeRendering(o.renderSegs.bind(o, "businessHours"), o.unrender.bind(o, "businessHours"), [r]), n.renderDateSelection = g.memoizeRendering(n._renderDateSelection, n._unrenderDateSelection, [r]), n.renderFgEvents = g.memoizeRendering(i.renderSegs.bind(i), i.unrender.bind(i), [r]), n.renderBgEvents = g.memoizeRendering(o.renderSegs.bind(o, "bgEvent"), o.unrender.bind(o, "bgEvent"), [r]), n.renderEventSelection = g.memoizeRendering(i.selectByInstanceId.bind(i), i.unselectByInstanceId.bind(i), [n.renderFgEvents]), n.renderEventDrag = g.memoizeRendering(n._renderEventDrag, n._unrenderEventDrag, [r]), n.renderEventResize = g.memoizeRendering(n._renderEventResize, n._unrenderEventResize, [r]), n
    }

    var b, w = (t(D, b = g.Splitter), D.prototype.getKeyInfo = function () {
        return {allDay: {}, timed: {}}
    }, D.prototype.getKeysForDateSpan = function (e) {
        return e.allDay ? ["allDay"] : ["timed"]
    }, D.prototype.getKeysForEventDef = function (e) {
        return e.allDay ? g.hasBgRendering(e) ? ["timed", "allDay"] : ["allDay"] : ["timed"]
    }, D);
    ...
    var T, C = g.createFormatter({week: "short"}), R = (t(I, T = g.View), I.prototype.render = function (e, t) {
        ...
        this.el.classList.add("fc-timeGrid-view"), this.el.innerHTML = this.renderSkeletonHtml(), this.scroller = new g.ScrollComponent("hidden", "auto");
        var t = this.scroller.el;
        this.el.querySelector(".fc-body > tr > td").appendChild(t), t.classList.add("fc-time-grid-container");
        var n, r = g.createElement("div", {className: "fc-time-grid"});
        t.appendChild(r), this.timeGrid = new S(r, {
            renderBgIntroHtml: this.renderTimeGridBgIntroHtml,
            renderIntroHtml: this.renderTimeGridIntroHtml
        }), e.options.allDaySlot && (this.dayGrid = new c.DayGrid(this.el.querySelector(".fc-day-grid"), {
            renderNumberIntroHtml: this.renderDayGridIntroHtml,
            renderBgIntroHtml: this.renderDayGridBgIntroHtml,
            renderIntroHtml: this.renderDayGridIntroHtml,
            colWeekNumbersVisible: !1,
            cellWeekNumbersVisible: !1
        }), n = this.el.querySelector(".fc-divider"), this.dayGrid.bottomCoordPadding = n.getBoundingClientRect().height)
        ...
        T.prototype.updateSize.call(this, e, t, n), this.timeGrid.updateSize(e), this.dayGrid && this.dayGrid.updateSize(e)
    }, I.prototype.updateBaseSize = function (e, t, n) {
        var r, i, o, s, a = this;
        this.axisWidth = g.matchCellWidths(g.findElements(this.el, ".fc-axis")), this.timeGrid.colEls ? (s = g.findElements(this.el, ".fc-row").filter(function (e) {
            return !a.scroller.el.contains(e)
        }), this.timeGrid.bottomRuleEl.style.display = "none", this.scroller.clear(), s.forEach(g.uncompensateScroll), this.dayGrid && (this.dayGrid.removeSegPopover(), (r = this.context.options.eventLimit) && "number" != typeof r && (r = 5), r && this.dayGrid.limitRows(r)), n || (i = this.computeScrollerHeight(t), this.scroller.setHeight(i), ((o = this.scroller.getScrollbarWidths()).left || o.right) && (s.forEach(function (e) {
            g.compensateScroll(e, o)
        }), i = this.computeScrollerHeight(t), this.scroller.setHeight(i)), this.scroller.lockOverflow(o), this.timeGrid.getTotalSlatHeight() < i && (this.timeGrid.bottomRuleEl.style.display = ""))) : n || (i = this.computeScrollerHeight(t), this.scroller.setHeight(i))
    ...
    function I() {
        ...
        return a.splitter = new w, a.renderSkeleton = g.memoizeRendering(a._renderSkeleton, a._unrenderSkeleton), a.renderHeadIntroHtml = function () {
            var e, t = a.context, n = t.theme, r = t.dateEnv, i = t.options, o = a.props.dateProfile.renderRange,
                s = g.diffDays(o.start, o.end);
            return i.weekNumbers ? (e = r.format(o.start, C), '<th class="fc-axis fc-week-number ' + n.getClass("widgetHeader") + '" ' + a.axisStyleAttr() + ">" + g.buildGotoAnchorHtml(i, r, {
                date: o.start,
                type: "week",
                forceOff: 1 < s
            }, g.htmlEscape(e)) + "</th>") : '<th class="fc-axis ' + n.getClass("widgetHeader") + '" ' + a.axisStyleAttr() + "></th>"
        }, a.renderTimeGridBgIntroHtml = function () {
            return '<td class="fc-axis ' + a.context.theme.getClass("widgetContent") + '" ' + a.axisStyleAttr() + "></td>"
        }, a.renderTimeGridIntroHtml = function () {
            return '<td class="fc-axis" ' + a.axisStyleAttr() + "></td>"
        }, a.renderDayGridBgIntroHtml = function () {
            var e = a.context, t = e.theme, n = e.options;
            return '<td class="fc-axis ' + t.getClass("widgetContent") + '" ' + a.axisStyleAttr() + "><span>" + g.getAllDayHtml(n) + "</span></td>"
    ...
    var k, x = (t(M, k = g.DateComponent), M.prototype.firstContext = function (e) {
        e.calendar.registerInteractiveComponent(this, {el: this.timeGrid.el})
    }, M.prototype.destroy = function () {
        k.prototype.destroy.call(this), this.context.calendar.unregisterInteractiveComponent(this)
    }, M.prototype.render = function (e, t) {
        var n = this.context.dateEnv, r = e.dateProfile, i = e.dayTable,
            o = this.dayRanges = this.buildDayRanges(i, r, n), s = this.timeGrid;
        s.receiveContext(t), s.receiveProps(l({}, this.slicer.sliceProps(e, r, null, t.calendar, s, o), {
            dateProfile: r,
            cells: i.cells[0]
        }), t)
    ...
    function M(e) {
        ...
        return t.buildDayRanges = g.memoize(P), t.slicer = new _, t.timeGrid = e, t
    }
    ...
    var H, _ = (t(O, H = g.Slicer), O.prototype.sliceRange = function (e, t) {
    ...
    var z, N = (t(L, z = R), L.prototype.render = function (e, t) {
        z.prototype.render.call(this, e, t);
        var n = this.props, r = n.dateProfile, i = n.dateProfileGenerator, o = t.nextDayThreshold,
            s = this.buildDayTable(r, i), a = this.splitter.splitProps(e);
        this.header && this.header.receiveProps({
            dateProfile: r,
            dates: s.headerDates,
            datesRepDistinctDays: !0,
            renderIntroHtml: this.renderHeadIntroHtml
        }, t), this.simpleTimeGrid.receiveProps(l({}, a.timed, {
            dateProfile: r,
            dayTable: s
        }), t), this.simpleDayGrid && this.simpleDayGrid.receiveProps(l({}, a.allDay, {
            dateProfile: r,
            dayTable: s,
            nextDayThreshold: o,
            isRigid: !1
        }), t), this.startNowIndicator(r, i)
    }, L.prototype._renderSkeleton = function (e) {
        z.prototype._renderSkeleton.call(this, e), e.options.columnHeader && (this.header = new g.DayHeader(this.el.querySelector(".fc-head-container"))), this.simpleTimeGrid = new x(this.timeGrid), this.dayGrid && (this.simpleDayGrid = new c.SimpleDayGrid(this.dayGrid))
    }, L.prototype._unrenderSkeleton = function () {
        z.prototype._unrenderSkeleton.call(this), this.header && this.header.destroy(), this.simpleTimeGrid.destroy(), this.simpleDayGrid && this.simpleDayGrid.destroy()
    ...
    var V = g.createPlugin({
        ...
        views: {
            timeGrid: {class: N, allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0},
            timeGridDay: {type: "timeGrid", duration: {days: 1}},
            timeGridWeek: {type: "timeGrid", duration: {weeks: 1}}
        }
    });
    e.AbstractTimeGridView = R, e.TimeGrid = S, e.TimeGridSlicer = _, e.TimeGridView = N, e.buildDayRanges = P, e.buildDayTable = B, e.default = V, Object.defineProperty(e, "__esModule", {value: !0})
});