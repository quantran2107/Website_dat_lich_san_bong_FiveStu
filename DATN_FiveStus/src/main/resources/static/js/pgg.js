...
//         </div>
//             <!-- Bảng khách hàng bên phải -->
//         <div class="col-md-6" id="tableBenPhai" style="display: block;">
//         <label class="sr-only" for="search">Tìm kiếm</label>
//         <input class="form-control mr-5" id="searchKH"
//         placeholder="Tìm kiếm theo mã, tên , sdt"
...
//                 document.getElementById('doiTuongTatCa').checked = true;
//                 document.getElementById('tableBenPhai').style.display = 'none';
//             } else {
...
//                     const doiTuongTatCa = document.getElementById('doiTuongTatCa');
//                     if (doiTuongTatCa.checked) {
//                         ableBenPhai.style.display = 'none';
//                     } else {
//                         // Nếu đang chọn tìm kiếm theo cá nhân, hiển thị danh sách theo query rỗng
//                         fetchKhachHang(query, 1, pageSize);
//                     }
...
function renderAddForm(container) {
    const formHTML = `
        <form id="addForm">
            ...
            <button type="submit" class="btn btn-success" onclick="handleAddFormSubmit()">Lưu</button>
            <button type="button" class="btn btn-secondary" onclick="cancelAdd()">Hủy</button>
        </form>
    `;
...
function renderUpdateForm(container) {
    const formHTML = `
        <form id="updateForm">
            ...
            <button type="submit" class="btn btn-success" onclick="handleUpdateFormSubmit()">Lưu</button>
            <button type="button" class="btn btn-secondary" onclick="cancelAdd()">Hủy</button>
        </form>
    `;
    container.innerHTML = formHTML;
