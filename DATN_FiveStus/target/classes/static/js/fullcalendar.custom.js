!function (e, t) {
    ...
    var r, n, a,
        p = (r = t.Theme, o(n = c, a = r), n.prototype = null === a ? Object.create(a) : (i.prototype = a.prototype, new i), c);
    ...
    p.prototype.classes = {
        ...
        listView: "card"
    }, p.prototype.baseIconClass = "fe", p.prototype.iconClasses = {
        close: "fe-x",
        prev: "fe-chevron-left",
        next: "fe-chevron-right",
        prevYear: "fe-chevrons-left",
        nextYear: "fe-chevron-right"
    }, p.prototype.iconOverrideOption = "bootstrapFontAwesome", p.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome", p.prototype.iconOverridePrefix = "fe-";
    var l = t.createPlugin({themeClasses: {bootstrap: p}});
    e.BootstrapTheme = p, e.default = l, Object.defineProperty(e, "__esModule", {value: !0})
});