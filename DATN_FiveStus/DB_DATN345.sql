...
INSERT INTO phieu_giam_gia (ma_phieu_giam_gia, ten_phieu_giam_gia, so_luong, muc_giam, hinh_thuc_giam_gia, dieu_kien_su_dung, ngay_bat_dau, ngay_ket_thuc, trang_thai, created_at, updated_at, deleted_at)
VALUES
  ('PGG001', 'Phieu giam gia 1', 10, 10000, 0.1, 'Dieu kien 1', NOW(), NOW(), 1, NOW(), NOW(), 1),
  ('PGG002', 'Phieu giam gia 2', 20, 20000, 0.2, 'Dieu kien 2', NOW(), NOW(), 1, NOW(), NOW(), 1),
  ('PGG003', 'Phieu giam gia 3', 30, 30000, 0.3, 'Dieu kien 3', NOW(), NOW(), 1, NOW(), NOW(), 1),
  ('PGG004', 'Phieu giam gia 4', 40, 50000, 0.4, 'Dieu kien 4', NOW(), NOW(), 0, NOW(), NOW(), 0),
  ('PGG005', 'Phieu giam gia 5', 50, 70000, 0.5, 'Dieu kien 5', NOW(), NOW(), 0, NOW(), NOW(), 0);


INSERT INTO hoa_don (id_nhan_vien, id_phieu_giam_gia, id_khach_hang, ma_hoa_don, email, ngay_tao, so_dien_thoai_nguoi_dat, ten_nguoi_dat, tong_tien, tien_coc, tien_con_lai, tien_thua, ghi_chu, trang_thai, ngay_den_san, ngay_thanh_toan, created_at, updated_at, deleted_at)
VALUES
  (1, 1, 1, 'HD001', 'nguyenvana@gmail.com', NOW(), '0123456789', 'Nguyen Van A', 100000, 50000, 50000, 0, 'Ghi chu 1', 'active',  NOW(), NOW(), NOW(), NOW(), 1),
  (2, 2, 2, 'HD002', 'nguyenvanb@gmail.com', NOW(), '0987654321', 'Nguyen Van B', 200000, 100000, 100000, 0, 'Ghi chu 2', 'active',  NOW(), NOW(), NOW(), NOW(), 1),
  (3, 3, 3, 'HD003', 'nguyenvanc@gmail.com', NOW(), '0123456789', 'Nguyen Van C', 300000, 150000, 150000, 0, 'Ghi chu 3', 'inactive',  NOW(), NOW(), NOW(), NOW(), 1),
  (4, 4, 4, 'HD004', 'nguyenvand@gmail.com', NOW(), '0987654321', 'Nguyen Van D', 400000, 200000, 200000, 0, 'Ghi chu 4', 'active',  NOW(), NOW(), NOW(), NOW(), 0),
  (5, 5, 5, 'HD005', 'nguyenvane@gmail.com', NOW(), '0123456789', 'Nguyen Van E', 500000, 250000, 250000, 0, 'Ghi chu 5', 'active', NOW(), NOW(), NOW(), NOW(), 0);

INSERT INTO san_bong (ten_san_bong, gia_san, trang_thai, created_at, updated_at, deleted_at)
VALUES
  ('San bong 1', 100000, 'active', NOW(), NOW(), 1),
  ('San bong 2', 200000, 'active', NOW(), NOW(), 1),
  ('San bong 3', 300000, 'inactive', NOW(), NOW(), 1),
  ('San bong 4', 400000, 'active', NOW(), NOW(), 0),
  ('San bong 5', 500000, 'active', NOW(), NOW(), 0);
...
INSERT INTO ngay_trong_tuan (thu_trong_tuan, gia_ca, he_so, trang_thai, created_at, updated_at, deleted_at)
VALUES
  ('Monday', 100000, 1.0, 'active', NOW(), NOW(), 1),
  ('Tuesday', 200000, 1.2, 'active', NOW(), NOW(), 1),
  ('Wednesday', 300000, 1.5, 'inactive', NOW(), NOW(), 0),
  ('Thursday', 400000, 1.8, 'active', NOW(), NOW(), 0),
  ('Friday', 500000, 2.0, 'active', NOW(), NOW(), 0);

INSERT INTO san_ca (id_ca, id_san_bong, id_ngay_trong_tuan, trang_thai, created_at, updated_at, deleted_at)
VALUES
  (1, 1, 1, 'active', NOW(), NOW(), 1),
  (2, 2, 2, 'active', NOW(), NOW(), 1),
  (3, 3, 3, 'inactive', NOW(), NOW(), 1),
  (4, 4, 4, 'active', NOW(), NOW(), 0),
  (5, 5, 5, 'active', NOW(), NOW(), 0);
...
INSERT INTO phu_phi_hoa_don (id_hoa_don_chi_tiet, thoi_gian_tao, trang_thai, created_at, updated_at, deleted_at)
VALUES
  (1, NOW(), 'active', NOW(), NOW(), 0),
  (2, NOW(), 'active', NOW(), NOW(), 0),
  (3, NOW(), 'inactive', NOW(), NOW(), 0),
  (4, NOW(), 'active', NOW(), NOW(), 0),
  (5, NOW(), 'active', NOW(), NOW(), 0);
