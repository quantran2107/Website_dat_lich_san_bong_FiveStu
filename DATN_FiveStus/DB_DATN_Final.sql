...
CREATE TABLE hoa_don_chi_tiet (
  ...
  id_san_ca INT NOT NULL,
   ma_hoa_don_chi_tiet VARCHAR(100) NOT NULL,
...
VALUES
  ...
  (1, 1, 1, 11000, 'Còn trống', NOW(), NOW(), 0),
  (1, 2, 2, 12000, 'Còn trống', NOW(), NOW(), 0),
  (1, 3, 3, 13000, 'Còn trống', NOW(), NOW(), 0),
  (1, 4, 4, 14000, 'Còn trống', NOW(), NOW(), 0),
  (1, 5, 5, 15000, 'Còn trống', NOW(), NOW(), 0),

  (1, 6, 6, 16000, 'Còn trống', NOW(), NOW(), 0),
  (1, 7, 7, 17000, 'Còn trống', NOW(), NOW(), 0),
  (1, 8, 1, 18000, 'Còn trống', NOW(), NOW(), 0),
  (1, 9, 2, 19000, 'Còn trống', NOW(), NOW(), 0),
  (1, 10, 3, 20000, 'Còn trống', NOW(), NOW(), 0),

  (2, 11, 4, 21000, 'Còn trống', NOW(), NOW(), 0),
  (2, 12, 5, 22000, 'Còn trống', NOW(), NOW(), 0),
  (2, 13, 6, 23000, 'Còn trống', NOW(), NOW(), 0),
  (2, 14, 7, 24000, 'Còn trống', NOW(), NOW(), 0),
  (2, 15, 1, 25000, 'Còn trống', NOW(), NOW(), 0),

  (2, 16, 2, 26000, 'Còn trống', NOW(), NOW(), 0),
  (2, 17, 3, 27000, 'Còn trống', NOW(), NOW(), 0),
  (2, 18, 4, 28000, 'Còn trống', NOW(), NOW(), 0),
  (2, 19, 5, 29000, 'Còn trống', NOW(), NOW(), 0),
  (2, 20, 6, 30000, 'Còn trống', NOW(), NOW(), 0),

  (3, 21, 7, 31000, 'Còn trống', NOW(), NOW(), 0),
  (3, 22, 1, 32000, 'Còn trống', NOW(), NOW(), 0),
  (3, 1, 2, 33000, 'Còn trống', NOW(), NOW(), 0),
  (3, 2, 3, 34000, 'Còn trống', NOW(), NOW(), 0),
  (3, 3, 4, 35000, 'Còn trống', NOW(), NOW(), 0),

  (3, 4, 5, 36000, 'Còn trống', NOW(), NOW(), 0),
  (3, 5, 6, 37000, 'Còn trống', NOW(), NOW(), 0),
  (3, 6, 7, 38000, 'Còn trống', NOW(), NOW(), 0),
  (3, 7, 1, 39000, 'Còn trống', NOW(), NOW(), 0),
  (3, 8, 2, 40000, 'Còn trống', NOW(), NOW(), 0),

  (4, 9, 3, 41000, 'Còn trống', NOW(), NOW(), 0),
  (4, 10, 4, 42000, 'Còn trống', NOW(), NOW(), 0),
  (4, 11, 5, 43000, 'Còn trống', NOW(), NOW(), 0),
  (4, 12, 6, 44000, 'Còn trống', NOW(), NOW(), 0),
  (4, 13, 7, 45000, 'Còn trống', NOW(), NOW(), 0),

  (4, 14, 1, 46000, 'Còn trống', NOW(), NOW(), 0),
  (4, 15, 2, 47000, 'Còn trống', NOW(), NOW(), 0),
  (4, 16, 3, 48000, 'Còn trống', NOW(), NOW(), 0),
  (4, 17, 4, 49000, 'Còn trống', NOW(), NOW(), 0),
  (4, 18, 5, 50000, 'Còn trống', NOW(), NOW(), 0),

  (5, 19, 6, 51000, 'Còn trống', NOW(), NOW(), 0),
  (5, 20, 7, 52000, 'Còn trống', NOW(), NOW(), 0),
  (5, 21, 1, 53000, 'Còn trống', NOW(), NOW(), 0),
  (5, 22, 2, 54000, 'Còn trống', NOW(), NOW(), 0),
  (6, 1, 3, 55000, 'Còn trống', NOW(), NOW(), 0),

  (6, 2, 4, 56000, 'Còn trống', NOW(), NOW(), 0),
  (6, 3, 5, 57000, 'Còn trống', NOW(), NOW(), 0),
  (6, 4, 6, 58000, 'Còn trống', NOW(), NOW(), 0),
  (6, 5, 7, 59000, 'Còn trống', NOW(), NOW(), 0),
  (6, 6, 1, 60000, 'Còn trống', NOW(), NOW(), 0),

  (7, 7, 2, 61000, 'Còn trống', NOW(), NOW(), 0),
  (7, 8, 3, 62000, 'Còn trống', NOW(), NOW(), 0),
  (7, 9, 4, 63000, 'Còn trống', NOW(), NOW(), 0),
  (7, 10, 5, 64000, 'Còn trống', NOW(), NOW(), 0),
  (7, 11, 6, 65000, 'Còn trống', NOW(), NOW(), 0),

  (7, 12, 7, 66000, 'Còn trống', NOW(), NOW(), 0),
  (7, 13, 1, 67000, 'Còn trống', NOW(), NOW(), 0),
  (7, 14, 2, 68000, 'Còn trống', NOW(), NOW(), 0),
  (7, 15, 3, 69000, 'Còn trống', NOW(), NOW(), 0),
  (8, 16, 4, 70000, 'Còn trống', NOW(), NOW(), 0),
  
  (1, 11, 1, 11000, 'Còn trống', NOW(), NOW(), 0),
  (1, 12, 2, 12000, 'Còn trống', NOW(), NOW(), 0),
  (1, 13, 3, 13000, 'Còn trống', NOW(), NOW(), 0),
  (1, 14, 4, 14000, 'Còn trống', NOW(), NOW(), 0),
  (1, 15, 5, 15000, 'Còn trống', NOW(), NOW(), 0),

  (1, 16, 6, 16000, 'Còn trống', NOW(), NOW(), 0),
  (1, 17, 7, 17000, 'Còn trống', NOW(), NOW(), 0),
  (1, 18, 1, 18000, 'Còn trống', NOW(), NOW(), 0),
  (1, 19, 2, 19000, 'Còn trống', NOW(), NOW(), 0),
  (1, 20, 3, 20000, 'Còn trống', NOW(), NOW(), 0),

  (2, 21, 4, 21000, 'Còn trống', NOW(), NOW(), 0),
  (2, 22, 5, 22000, 'Còn trống', NOW(), NOW(), 0),
  (2, 11, 6, 23000, 'Còn trống', NOW(), NOW(), 0),
  (2, 12, 7, 24000, 'Còn trống', NOW(), NOW(), 0),
  (2, 13, 1, 25000, 'Còn trống', NOW(), NOW(), 0),

  (2, 14, 2, 26000, 'Còn trống', NOW(), NOW(), 0),
  (2, 15, 3, 27000, 'Còn trống', NOW(), NOW(), 0),
  (2, 16, 4, 28000, 'Còn trống', NOW(), NOW(), 0),
  (2, 17, 5, 29000, 'Còn trống', NOW(), NOW(), 0),
  (2, 18, 6, 30000, 'Còn trống', NOW(), NOW(), 0),

  (3, 19, 7, 31000, 'Còn trống', NOW(), NOW(), 0),
  (3, 20, 1, 32000, 'Còn trống', NOW(), NOW(), 0),
  (3, 21, 2, 33000, 'Còn trống', NOW(), NOW(), 0),
  (3, 22, 3, 34000, 'Còn trống', NOW(), NOW(), 0),
  (3, 11, 4, 35000, 'Còn trống', NOW(), NOW(), 0),

  (3, 12, 5, 36000, 'Còn trống', NOW(), NOW(), 0),
  (3, 13, 6, 37000, 'Còn trống', NOW(), NOW(), 0),
  (3, 14, 7, 38000, 'Còn trống', NOW(), NOW(), 0),
  (3, 15, 1, 39000, 'Còn trống', NOW(), NOW(), 0),
  (3, 16, 2, 40000, 'Còn trống', NOW(), NOW(), 0),

  (4, 17, 3, 41000, 'Còn trống', NOW(), NOW(), 0),
  (4, 18, 4, 42000, 'Còn trống', NOW(), NOW(), 0),
  (4, 19, 5, 43000, 'Còn trống', NOW(), NOW(), 0),
  (4, 20, 6, 44000, 'Còn trống', NOW(), NOW(), 0),
  (4, 21, 7, 45000, 'Còn trống', NOW(), NOW(), 0),

  (4, 22, 1, 46000, 'Còn trống', NOW(), NOW(), 0),
  (4, 11, 2, 47000, 'Còn trống', NOW(), NOW(), 0),
  (4, 12, 3, 48000, 'Còn trống', NOW(), NOW(), 0),
  (4, 13, 4, 49000, 'Còn trống', NOW(), NOW(), 0),
  (4, 14, 5, 50000, 'Còn trống', NOW(), NOW(), 0),

  (5, 15, 6, 51000, 'Còn trống', NOW(), NOW(), 0),
  (5, 16, 7, 52000, 'Còn trống', NOW(), NOW(), 0),
  (5, 17, 1, 53000, 'Còn trống', NOW(), NOW(), 0),
  (5, 18, 2, 54000, 'Còn trống', NOW(), NOW(), 0),
  (5, 19, 3, 55000, 'Còn trống', NOW(), NOW(), 0),

  (5, 20, 4, 56000, 'Còn trống', NOW(), NOW(), 0),
  (5, 21, 5, 57000, 'Còn trống', NOW(), NOW(), 0),
  (5, 22, 6, 58000, 'Còn trống', NOW(), NOW(), 0),
  (5, 11, 7, 59000, 'Còn trống', NOW(), NOW(), 0),
  (6, 12, 1, 60000, 'Còn trống', NOW(), NOW(), 0),

  (6, 13, 2, 61000, 'Còn trống', NOW(), NOW(), 0),
  (6, 14, 3, 62000, 'Còn trống', NOW(), NOW(), 0),
  (6, 15, 4, 63000, 'Còn trống', NOW(), NOW(), 0),
  (6, 16, 5, 64000, 'Còn trống', NOW(), NOW(), 0),
  (6, 17, 6, 65000, 'Còn trống', NOW(), NOW(), 0),

  (7, 18, 7, 66000, 'Còn trống', NOW(), NOW(), 0),
  (7, 19, 1, 67000, 'Còn trống', NOW(), NOW(), 0),
  (7, 20, 2, 68000, 'Còn trống', NOW(), NOW(), 0),
  (7, 21, 3, 69000, 'Còn trống', NOW(), NOW(), 0),
  (7, 22, 4, 70000, 'Còn trống', NOW(), NOW(), 0),

  (8, 11, 5, 71000, 'Còn trống', NOW(), NOW(), 0),
  (8, 12, 6, 72000, 'Còn trống', NOW(), NOW(), 0),
  (8, 13, 7, 73000, 'Còn trống', NOW(), NOW(), 0),
  (8, 14, 1, 74000, 'Còn trống', NOW(), NOW(), 0),
  (8, 15, 2, 75000, 'Còn trống', NOW(), NOW(), 0);



INSERT INTO hoa_don_chi_tiet (id_hoa_don, id_san_ca, ma_hoa_don_chi_tiet, tien_san, ngay_den_san, ghi_chu, trang_thai, created_at, updated_at, deleted_at)
VALUES
(61, 1, 'HDCT061-1', 500000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD061-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(62, 2, 'HDCT062-1', 600000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD062-1', 'Đang hoạt động', NOW(), NOW(), 0),
(63, 3, 'HDCT063-1', 550000, NOW(), 'Ghi chú HD063-1', 'Đang hoạt động', NOW(), NOW(), 0),
(64, 4, 'HDCT064-1', 650000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD064-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(65, 5, 'HDCT065-1', 700000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD065-1', 'Đang hoạt động', NOW(), NOW(), 0),
(66, 6, 'HDCT066-1', 750000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD066-1', 'Đang hoạt động', NOW(), NOW(), 0),
(67, 7, 'HDCT067-1', 800000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD067-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(68, 8, 'HDCT068-1', 850000, NOW(), 'Ghi chú HD068-1', 'Đang hoạt động', NOW(), NOW(), 0),
(69, 9, 'HDCT069-1', 900000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD069-1', 'Đang hoạt động', NOW(), NOW(), 0),
(70, 10, 'HDCT070-1', 950000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD070-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(71, 11, 'HDCT071-1', 500000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD071-1', 'Đang hoạt động', NOW(), NOW(), 0),
(72, 12, 'HDCT072-1', 600000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD072-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(73, 13, 'HDCT073-1', 550000, NOW(), 'Ghi chú HD073-1', 'Đang hoạt động', NOW(), NOW(), 0),
(74, 14, 'HDCT074-1', 650000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD074-1', 'Đang hoạt động', NOW(), NOW(), 0),
(75, 15, 'HDCT075-1', 700000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD075-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(76, 16, 'HDCT076-1', 750000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD076-1', 'Đang hoạt động', NOW(), NOW(), 0),
(77, 17, 'HDCT077-1', 800000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD077-1', 'Đang hoạt động', NOW(), NOW(), 0),
(78, 18, 'HDCT078-1', 850000, NOW(), 'Ghi chú HD078-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(79, 19, 'HDCT079-1', 900000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD079-1', 'Đang hoạt động', NOW(), NOW(), 0),
(80, 20, 'HDCT080-1', 950000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD080-1', 'Đang hoạt động', NOW(), NOW(), 0),
(21, 21, 'HDCT021-1', 500000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD021-1', 'Đã thanh toán', NOW(), NOW(), 0),
(22, 22, 'HDCT022-1', 600000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD022-1', 'Đã thanh toán', NOW(), NOW(), 0),
(23, 23, 'HDCT023-1', 550000, NOW(), 'Ghi chú HD023-1', 'Đã thanh toán', NOW(), NOW(), 0),
(24, 24, 'HDCT024-1', 650000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD024-1', 'Đã thanh toán', NOW(), NOW(), 0),
(25, 25, 'HDCT025-1', 700000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD025-1', 'Đã thanh toán', NOW(), NOW(), 0),
(26, 26, 'HDCT026-1', 750000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD026-1', 'Đã thanh toán', NOW(), NOW(), 0),
(27, 27, 'HDCT027-1', 800000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD027-1', 'Đã thanh toán', NOW(), NOW(), 0),
(28, 28, 'HDCT028-1', 850000, NOW(), 'Ghi chú HD028-1', 'Đã thanh toán', NOW(), NOW(), 0),
(29, 29, 'HDCT029-1', 900000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD029-1', 'Đã thanh toán', NOW(), NOW(), 0),
(30, 30, 'HDCT030-1', 950000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD030-1', 'Đã thanh toán', NOW(), NOW(), 0),
(31, 31, 'HDCT031-1', 500000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD031-1', 'Đã thanh toán', NOW(), NOW(), 0),
(32, 32, 'HDCT032-1', 600000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD032-1', 'Đã thanh toán', NOW(), NOW(), 0),
(33, 33, 'HDCT033-1', 550000, NOW(), 'Ghi chú HD033-1', 'Đã thanh toán', NOW(), NOW(), 0),
(34, 34, 'HDCT034-1', 650000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD034-1', 'Đã thanh toán', NOW(), NOW(), 0),
(35, 35, 'HDCT035-1', 700000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD035-1', 'Đã thanh toán', NOW(), NOW(), 0),
(36, 36, 'HDCT036-1', 750000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD036-1', 'Đã thanh toán', NOW(), NOW(), 0),
(37, 37, 'HDCT037-1', 800000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD037-1', 'Đã thanh toán', NOW(), NOW(), 0),
(38, 38, 'HDCT038-1', 850000, NOW(), 'Ghi chú HD038-1', 'Đã thanh toán', NOW(), NOW(), 0),
(39, 39, 'HDCT039-1', 900000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD039-1', 'Đã thanh toán', NOW(), NOW(), 0),
(40, 40, 'HDCT040-1', 950000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD040-1', 'Đã thanh toán', NOW(), NOW(), 0),
(41, 1, 'HDCT041-1', 500000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD041-1', 'Đã thanh toán', NOW(), NOW(), 0),
(42, 2, 'HDCT042-1', 600000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD042-1', 'Đã thanh toán', NOW(), NOW(), 0),
(43, 3, 'HDCT043-1', 550000, NOW(), 'Ghi chú HD043-1', 'Đã thanh toán', NOW(), NOW(), 0),
(44, 4, 'HDCT044-1', 650000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD044-1', 'Đã thanh toán', NOW(), NOW(), 0),
(45, 5, 'HDCT045-1', 700000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD045-1', 'Đã thanh toán', NOW(), NOW(), 0),
(46, 6, 'HDCT046-1', 750000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD046-1', 'Đã thanh toán', NOW(), NOW(), 0),
(47, 7, 'HDCT047-1', 800000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD047-1', 'Đã thanh toán', NOW(), NOW(), 0),
(48, 8, 'HDCT048-1', 850000, NOW(), 'Ghi chú HD048-1', 'Đã thanh toán', NOW(), NOW(), 0),
(49, 9, 'HDCT049-1', 900000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD049-1', 'Đã thanh toán', NOW(), NOW(), 0),
(50, 10, 'HDCT050-1', 950000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD050-1', 'Đã thanh toán', NOW(), NOW(), 0),
(51, 1, 'HDCT051-1', 500000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD051-1', 'Đã thanh toán', NOW(), NOW(), 0),
(52, 2, 'HDCT052-1', 600000, NOW(), 'Ghi chú HD052-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(53, 3, 'HDCT053-1', 550000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD053-1', 'Đang hoạt động', NOW(), NOW(), 0),
(54, 4, 'HDCT054-1', 650000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD054-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(55, 5, 'HDCT055-1', 700000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD055-1', 'Đang hoạt động', NOW(), NOW(), 0),
(56, 6, 'HDCT056-1', 750000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD056-1', 'Đang hoạt động', NOW(), NOW(), 0),
(57, 7, 'HDCT057-1', 800000, NOW(), 'Ghi chú HD057-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(58, 8, 'HDCT058-1', 850000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD058-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(59, 9, 'HDCT059-1', 900000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD059-1', 'Đang hoạt động', NOW(), NOW(), 0),
(60, 10, 'HDCT060-1', 950000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD060-1', 'Đang hoạt động', NOW(), NOW(), 0),
(61, 11, 'HDCT061-1', 500000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD061-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(62, 12, 'HDCT062-1', 600000, NOW(), 'Ghi chú HD062-1', 'Đang hoạt động', NOW(), NOW(), 0),
(63, 13, 'HDCT063-1', 550000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD063-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(64, 14, 'HDCT064-1', 650000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD064-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(65, 15, 'HDCT065-1', 700000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD065-1', 'Đang hoạt động', NOW(), NOW(), 0),
(66, 16, 'HDCT066-1', 750000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD066-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(67, 17, 'HDCT067-1', 800000, NOW(), 'Ghi chú HD067-1', 'Đang hoạt động', NOW(), NOW(), 0),
(68, 18, 'HDCT068-1', 850000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD068-1', 'Đang hoạt động', NOW(), NOW(), 0),
(69, 19, 'HDCT069-1', 900000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD069-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(70, 20, 'HDCT070-1', 950000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD070-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(71, 21, 'HDCT071-1', 500000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD071-1', 'Đang hoạt động', NOW(), NOW(), 0),
(72, 22, 'HDCT072-1', 600000, NOW(), 'Ghi chú HD072-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(73, 23, 'HDCT073-1', 550000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD073-1', 'Đang hoạt động', NOW(), NOW(), 0),
(74, 24, 'HDCT074-1', 650000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD074-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(75, 25, 'HDCT075-1', 700000, NOW() - INTERVAL 2 DAY, 'Ghi chú HD075-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(76, 26, 'HDCT076-1', 750000, NOW() - INTERVAL 1 DAY, 'Ghi chú HD076-1', 'Đang hoạt động', NOW(), NOW(), 0),
(77, 27, 'HDCT077-1', 800000, NOW(), 'Ghi chú HD077-1', 'Đang hoạt động', NOW(), NOW(), 0),
(78, 28, 'HDCT078-1', 850000, NOW() + INTERVAL 1 DAY, 'Ghi chú HD078-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(79, 29, 'HDCT079-1', 900000, NOW() + INTERVAL 2 DAY, 'Ghi chú HD079-1', 'Chờ nhận sân', NOW(), NOW(), 0),
-- Tháng trước
(8, 1, 'HDCT008-1', 500000, NOW() - INTERVAL 1 MONTH - INTERVAL 5 DAY, 'Ghi chú HD008-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(9, 2, 'HDCT009-1', 600000, NOW() - INTERVAL 1 MONTH + INTERVAL 10 DAY, 'Ghi chú HD009-1', 'Đang hoạt động', NOW(), NOW(), 0),
(10, 3, 'HDCT010-1', 550000, NOW() - INTERVAL 1 MONTH + INTERVAL 15 DAY, 'Ghi chú HD010-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(11, 4, 'HDCT011-1', 650000, NOW() - INTERVAL 1 MONTH + INTERVAL 20 DAY, 'Ghi chú HD011-1', 'Đang hoạt động', NOW(), NOW(), 0),
(12, 5, 'HDCT012-1', 700000, NOW() - INTERVAL 1 MONTH - INTERVAL 10 DAY, 'Ghi chú HD012-1', 'Chờ nhận sân', NOW(), NOW(), 0),

-- Tháng sau
(13, 1, 'HDCT013-1', 750000, NOW() + INTERVAL 1 MONTH + INTERVAL 5 DAY, 'Ghi chú HD013-1', 'Đang hoạt động', NOW(), NOW(), 0),
(14, 2, 'HDCT014-1', 800000, NOW() + INTERVAL 1 MONTH - INTERVAL 5 DAY, 'Ghi chú HD014-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(15, 3, 'HDCT015-1', 850000, NOW() + INTERVAL 1 MONTH + INTERVAL 10 DAY, 'Ghi chú HD015-1', 'Đang hoạt động', NOW(), NOW(), 0),
(16, 4, 'HDCT016-1', 900000, NOW() + INTERVAL 1 MONTH - INTERVAL 10 DAY, 'Ghi chú HD016-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(17, 5, 'HDCT017-1', 950000, NOW() + INTERVAL 1 MONTH + INTERVAL 15 DAY, 'Ghi chú HD017-1', 'Đang hoạt động', NOW(), NOW(), 0),
(18, 1, 'HDCT018-1', 500000, NOW() + INTERVAL 1 MONTH - INTERVAL 20 DAY, 'Ghi chú HD018-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(19, 2, 'HDCT019-1', 600000, NOW() + INTERVAL 1 MONTH + INTERVAL 5 DAY, 'Ghi chú HD019-1', 'Đang hoạt động', NOW(), NOW(), 0),
(20, 3, 'HDCT020-1', 550000, NOW() + INTERVAL 1 MONTH + INTERVAL 10 DAY, 'Ghi chú HD020-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(21, 4, 'HDCT021-1', 650000, NOW() + INTERVAL 1 MONTH - INTERVAL 15 DAY, 'Ghi chú HD021-1', 'Đang hoạt động', NOW(), NOW(), 0),
(22, 5, 'HDCT022-1', 700000, NOW() + INTERVAL 1 MONTH + INTERVAL 10 DAY, 'Ghi chú HD022-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(23, 1, 'HDCT023-1', 750000, NOW() + INTERVAL 1 MONTH + INTERVAL 15 DAY, 'Ghi chú HD023-1', 'Đang hoạt động', NOW(), NOW(), 0),
(24, 2, 'HDCT024-1', 800000, NOW() + INTERVAL 1 MONTH - INTERVAL 5 DAY, 'Ghi chú HD024-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(25, 3, 'HDCT025-1', 850000, NOW() + INTERVAL 1 MONTH - INTERVAL 10 DAY, 'Ghi chú HD025-1', 'Đang hoạt động', NOW(), NOW(), 0),
(26, 4, 'HDCT026-1', 900000, NOW() + INTERVAL 1 MONTH + INTERVAL 5 DAY, 'Ghi chú HD026-1', 'Chờ nhận sân', NOW(), NOW(), 0),
(27, 5, 'HDCT027-1', 950000, NOW() + INTERVAL 1 MONTH + INTERVAL 20 DAY, 'Ghi chú HD027-1', 'Đang hoạt động', NOW(), NOW(), 0);
